...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.2.3")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $return_ivar = Opal.return_ivar, $def = Opal.def, $send = Opal.send, $slice = Opal.slice, $hash_rehash = Opal.hash_rehash, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $assign_ivar_val = Opal.assign_ivar_val, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $assign_ivar = Opal.assign_ivar, $neqeq = Opal.neqeq, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('attr_reader,[]=,[],delete,instance_variable_get,to_sym,merge!,push,+,each,tag,<<,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,length,now');
  return (function($base, $super, $parent_nesting) {
    ...
    self.categories = ["communication", "effect", "event", "geometry", "hierarchy", "identity", "material", "property", "security", "spatial", "time", "utility"];
    ...
    return (function(self, $parent_nesting) {
      ...
      $def(self, '$add_to_particle_list', function $$add_to_particle_list($a, $b, $c) {
        ...
        return ($d = [particle, (new Map([["type", type], ["category", category]]))], $send(self.$instance_variable_get("@particle_list"), '[]=', $d), $d[$d.length - 1]);
      }, -3);
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('key?,include?,atome_list,[],puts,add_atomes_specificities,build_atome,to_proc,particle_list,instance_variable_set,build_particle,build_sanitizer,set_atomes_specificities,[]=,build_render,to_h,map,reject,merge,delete,grab,counter,==,instance_of?,to_sym,atomes,box,circle,define_method,default_params,send,eval,new,object_id,*,global,is_a?,instance_exec,call,<<,-,length,===,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,instance_variable_get,update_style');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$new', function $Object_new$1(params) {
      var bloc = $Object_new$1.$$p || nil, self = this, renderer_found = nil, render_method = nil;

      $Object_new$1.$$p = null;
      
      ;
      if ($truthy(params['$key?']("atome"))) {
        if ($truthy($$('Universe').$atome_list()['$include?'](params['$[]']("atome")))) {
          return self.$puts("atome " + (params['$[]']("atome")) + " already exist you can't create it")
        } else {
        ...
        if ($truthy($$('Universe').$particle_list()['$[]'](params['$[]']("particle")))) {
          return self.$puts("particle " + (params['$[]']("particle")) + " already exist you can't create it")
        } else {
          
          $$('Atome').$instance_variable_set("@main_" + (params['$[]']("particle")), bloc);
          return $send($$('Genesis'), 'build_particle', [params['$[]']("particle"), (new Map([["render", params['$[]']("render")], ["return", params['$[]']("return")], ["store", params['$[]']("store")], ["type", params['$[]']("type")], ["category", params['$[]']("category")]]))], bloc.$to_proc());
        }
...
Opal.modules["atome/genesis/generators/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,connect,html,to_proc,instance_of?,[]=,length,messages,store_messages,send_message,controller_sender,[],int8');
  ...
  $send(self, 'new', [(new Map([["particle", "message"], ["category", "communication"], ["type", "hash"]]))], function $$2(params, bloc){var self = $$2.$$s == null ? this : $$2.$$s, message_id = nil;
    ...
    return self.$html().$send_message(params);}, {$$s: self});
  ...
  return $send(self, 'new', [(new Map([["particle", "language"], ["category", "communication"], ["type", "string"]]))], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s;
...
Opal.modules["atome/genesis/generators/effect"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $send(self, 'new', [(new Map([["particle", "blur"], ["category", "effect"], ["type", "int"]]))], function $$1(params){
...
Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["sanitizer", "resize"]]))], function $$10(params, user_bloc){var $a, self = $$10.$$s == null ? this : $$10.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "overflow"], ["category", "event"], ["type", "boolean"]]))], function $$11(params, bloc){var self = $$11.$$s == null ? this : $$11.$$s, $ret_or_1 = nil;
...
Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$new((new Map([["particle", "id"], ["category", "identity"], ["type", "int"]])));
  ...
  return self.$new((new Map([["particle", "alien"], ["category", "identity"], ["type", "string"]])));
};

Opal.modules["atome/genesis/generators/material"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,each,send,[],delete_at,data,map,keys,delete,instance_of?,color,paint,==,puts,classes,[]=,|,id,gsub');
  ...
  $send(self, 'new', [(new Map([["post", "remove"]]))], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      ...
      switch (params['$[]']("all").valueOf()) {
        ...
        case "paint":
          ...
          break;
        default:
          $send(params, 'each', [], function $$8(particle, value){var self = $$8.$$s == null ? this : $$8.$$s;
            if (self.category == null) self.category = nil;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "classes"], ["category", "material"], ["type", "json"]]))], function $$9(value){var $a, self = $$9.$$s == null ? this : $$9.$$s, $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil, $binary_op_recvr_tmp_1 = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "remove_classes"], ["category", "material"], ["type", "boolean"]]))], function $$10(value){var self = $$10.$$s == null ? this : $$10.$$s;
  ...
  $send(self, 'new', [(new Map([["sanitizer", "definition"]]))], function $$11(params){
    
    if (params == null) params = nil;
    params = params.$gsub(/<svg[^>]*>|<\/svg>/, "");
    return params;});
  self.$new((new Map([["particle", "gradient"], ["category", "material"], ["type", "int"]])));
  return self.$new((new Map([["particle", "border"], ["category", "material"], ["type", "int"]])));
};

Opal.modules["atome/genesis/generators/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $thrower = Opal.thrower, $rb_minus = Opal.rb_minus, $t_$9 = $thrower('return'), self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('match,to_i,[],to_f,new,[]=,data,keys,insert,nil?,puts,sort_by!,values,-,instance_of?,to_s,is_a?,respond_to?');
  ...
  $send(self, 'new', [(new Map([["particle", "red"], ["category", "property"], ["type", "string"]]))], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;
    ...
    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "green"], ["category", "property"], ["type", "string"]]))], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "blue"], ["category", "property"], ["type", "string"]]))], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "alpha"], ["category", "property"], ["type", "string"]]))], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "diffusion"], ["category", "property"], ["type", "string"]]))], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "clean"], ["category", "property"], ["type", "boolean"]]))], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s, cell = nil, row_nb = nil, column_nb = nil;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "insert"], ["category", "property"], ["type", "string"]]))], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s, content = nil, cell = nil, row_nb = nil, column_nb = nil, position_to_insert = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "sort"], ["category", "property"], ["type", "int"]]))], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s, column = nil, method = nil;
    ...
    if (($truthy(column['$nil?']()) || ($truthy(method['$nil?']())))) {
      ...
      $t_$9.$throw(nil, $$8.$$is_lambda);
    };
    $send(self.data, 'sort_by!', [], function $$10(row){var value = nil;
...
Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "layout"], ["category", "spatial"], ["type", "int"]]))], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, mode_found = nil, $ret_or_1 = nil, elements_style = nil, atomes_to_organise = nil, container_name = nil, container = nil, container_class = nil, id_found = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "center"], ["category", "spatial"], ["type", "hash"]]))], function $$9(params){
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "login"], ["category", "utility"], ["type", "string"]]))], function $$13(params){var self = $$13.$$s == null ? this : $$13.$$s;
  ...
  $send(self, 'new', [(new Map([["particle", "match"], ["category", "utility"], ["type", "string"]]))], function $$14(params, _bloc){
    
    if (params == null) params = nil;
    if (_bloc == null) _bloc = nil;
    return params;});
  $send(self, 'new', [(new Map([["sanitizer", "match"]]))], function $$15(params, _bloc){
  ...
  $send(self, 'new', [(new Map([["particle", "duplicate"], ["category", "utility"], ["type", "string"], ["store", false]]))], function $$16(params){var self = $$16.$$s == null ? this : $$16.$$s, copy_number = nil, new_atome_id = nil, new_atome = nil, attached_atomes = nil, attached_found = nil, particles_found = nil, keys_to_delete = nil, $ret_or_1 = nil;
    ...
    $send(keys_to_delete, 'each', [], function $$17(key){
      
      if (key == null) key = nil;
      return particles_found.$delete(key);});
    params['$[]=']("id", new_atome_id);
    $send(particles_found, 'each', [], function $$18(particle_found){var self = $$18.$$s == null ? this : $$18.$$s, particle_name = nil, particle_content = nil;
    ...
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      $send(params, 'each', [], function $$20(k, v){
  ...
  return $send(self, 'new', [(new Map([["read", "css"]]))], function $$29(){var self = $$29.$$s == null ? this : $$29.$$s;
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $eqeq = Opal.eqeq, $gvars = Opal.gvars, $thrower = Opal.thrower, $slice = Opal.slice, $truthy = Opal.truthy, $to_a = Opal.to_a, $defs = Opal.defs, $not = Opal.not, $range = Opal.range, $rb_plus = Opal.rb_plus, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('require,instance_exec,grab,to_proc,==,to_json,inspect,eval,each,method,define_singleton_method,instance_variable_get,empty?,instance_variable_set,[],is_a?,call,set_help,get_help,set_example,get_example,send,atome_js,!,instance_of?,get_sanitizer_method,particle_sanitizer,atome_common,atome_pre_process,atome_post_process,[]=,story,attr_accessor,define_method,first,values,atome,each_with_object,instance_variables,to_sym,include?,delete,to_s,to_hash,collect,+,<<,puts,users,current_user=,debug,display,attach,remove,category,length,attached,messages,connection');
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.id = $proto.current_server = nil;
    ...
    (function(self, $parent_nesting) {
      ...
      return $def(self, '$monitoring', function $$monitoring(atomes_to_monitor, particles_to_monitor) {
        var bloc = $$monitoring.$$p || nil, self = this;

        $$monitoring.$$p = null;
        
        ;
        return $send(atomes_to_monitor, 'each', [], function $$1(atome_to_monitor){var self = $$1.$$s == null ? this : $$1.$$s;

          
          if (atome_to_monitor == null) atome_to_monitor = nil;
          return $send(particles_to_monitor, 'each', [], function $$2(monitored_particle){var self = $$2.$$s == null ? this : $$2.$$s, original_method = nil;

            
            if (monitored_particle == null) monitored_particle = nil;
            original_method = atome_to_monitor.$method(monitored_particle);
            return $send(atome_to_monitor, 'define_singleton_method', [monitored_particle], function $$3($a){var proc = $$3.$$p || nil, $post_args, args, self = $$3.$$s == null ? this : $$3.$$s, value_before = nil;
    ...
    $def(self, '$collapse', function $$collapse(new_atome) {
      ...
      return $send(new_atome, 'each', [], function $$4(element, value){var self = $$4.$$s == null ? this : $$4.$$s;
    ...
    $def(self, '$particle_callback', function $$particle_callback(element) {
      ...
      return $send($$('Atome'), 'define_method', ["" + (element) + "_callback"], function $$5(return_params){var self = $$5.$$s == null ? this : $$5.$$s, proc_found = nil;
    ...
    $def(self, '$particles', function $$particles(particles_found) {
      ...
      if ($truthy(particles_found)) {
        return $send(particles_found, 'each', [], function $$6(particle_found, value_found){var $a, self = $$6.$$s == null ? this : $$6.$$s;
    ...
    $def(self, '$atome', function $$atome() {
      ...
      return $send(self.$instance_variables(), 'each_with_object', [(new Map())], function $$7(var$, hash){var $a, self = $$7.$$s == null ? this : $$7.$$s;
    ...
    $def(self, '$to_hash', function $$to_hash() {
      ...
      hash = (new Map());
      $send(self.$instance_variables(), 'each', [], function $$8(var$){var $a, self = $$8.$$s == null ? this : $$8.$$s;
    ...
    $def(self, '$refresh', function $$refresh() {
      ...
      return $send(particles_found, 'each', [], function $$9(particle_found, value_found){var self = $$9.$$s == null ? this : $$9.$$s;
    ...
    $def(self, '$each', function $$each() {
      ...
      ;
      return $send(self.$collect(), 'each', [], function $$10(val){var self = $$10.$$s == null ? this : $$10.$$s;
    ...
    $def(self, '$each_with_index', function $$each_with_index() {
      ...
      ;
      index = 0;
      return $send(self.$collect(), 'each', [], function $$11(val){var self = $$11.$$s == null ? this : $$11.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$12(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$13(value) {
      var self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$14(particle, value){var self = $$14.$$s == null ? this : $$14.$$s;
    ...
    return $def(self, '$encrypt', function $$encrypt(string) {try { 
      var js_code = nil;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,atome_infos,server,init_websocket,particle_list,categories,atomes,password,message');
  ...
  $def(self, '$atome_genesis', function $$atome_genesis() {
    ...
    return $send($$('A'), 'init_websocket', [], function $$4(msg){var self = $$4.$$s == null ? this : $$4.$$s;

      
      if (msg == null) msg = nil;
      return self.$puts("-3 " + (msg));}, {$$s: self});
  });
  
  $def(self, '$init_database', function $$init_database() {
    var self = this, particles = nil, categories = nil, atomes = nil;

    
    particles = $$('Universe').$particle_list();
    categories = $$('Universe').$categories();
    atomes = $$('Universe').$atomes();
    return self.$puts("we are here!!");
  });
  return $def(self, '$user_login', function $$user_login() {
    var self = this, password = nil;

    
    password = $$('Black_matter').$password();
    $send(self, 'message', [(new Map([["action", "authentication"], ["data", (new Map([["email", "jeezs@atome.one"]]))]]))], function $$5(email){var self = $$5.$$s == null ? this : $$5.$$s;

      
      if (email == null) email = nil;
      return self.$puts("email received : " + (email));}, {$$s: self});
    return $send(self, 'message', [(new Map([["action", "authorization"], ["data", (new Map([["password", password]]))]]))], function $$6(p){var self = $$6.$$s == null ? this : $$6.$$s;

      
      if (p == null) p = nil;
      return self.$puts("2 : " + (p));}, {$$s: self});
  });
};

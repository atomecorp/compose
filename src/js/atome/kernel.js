...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.5.6")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $return_ivar = Opal.return_ivar, $def = Opal.def, $truthy = Opal.truthy, $send = Opal.send, $slice = Opal.slice, $hash_rehash = Opal.hash_rehash, $rb_plus = Opal.rb_plus, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $assign_ivar = Opal.assign_ivar, $neqeq = Opal.neqeq, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('attr_reader,attr_accessor,[]=,[],delete,instance_variable_get,to_sym,merge!,push,+,each,tag,<<,gsub,uuid,strftime,now,generate_uuid,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,sync,%,setItem,length');
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      self.$attr_accessor("allow_history", "database_ready");
      ...
      $def(self, '$historicize', function $$historicize(id, operation, element, params) {
        ...
        if (self.database_ready == null) self.database_ready = nil;
        if (self.allow_history == null) self.allow_history = nil;
        if (self.increment == null) self.increment = nil;
        if (self.history == null) self.history = nil;

        if (($truthy(self.allow_history) && ($truthy(self.database_ready)))) {
          
          $send($$('A'), 'sync', [(new Map([["action", "historicize"], ["data", (new Map([["table", "user"]]))]]))], function $$5(_db_state){
      ...
      return $def(self, '$story', function $$story(filter) {
        ...
        filtered_history = [];
        $send(self.history, 'each', [], function $$6(operation_number, alteration){
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('key?,include?,atome_list,[],puts,add_atomes_specificities,build_atome,to_proc,particle_list,instance_variable_set,build_particle,build_sanitizer,set_atomes_specificities,[]=,build_render,include,to_h,map,reject,merge,delete,grab,to_sym,app_identity,counter,atomes,==,atomes_ids,instance_of?,box,circle,define_method,default_params,send,eval,new,object_id,*,global,is_a?,instance_exec,call,<<,-,length,===,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,instance_variable_get,update_style');
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(new_atome) {
      ...
      self.int8 = (new Map());
      self.css = (new Map());
      self.aid = self.$identity_generator();
...
Opal.modules["atome/genesis/atomes"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["sanitizer", "element"]]))], function $$7(params){var default_params = nil;
  ...
  $send(self, 'new', [(new Map([["post", "text"]]))], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s, data_found = nil;

    
    if (params == null) params = nil;
    data_found = params['$[]']("data");
    if ($truthy(data_found['$instance_of?']($$('Array')))) {
      $send(data_found, 'each_with_index', [], function $$9(data_found, index){var self = $$9.$$s == null ? this : $$9.$$s;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["sanitizer", "text"]]))], function $$10(params){
    ...
    return params;});
  $send(self, 'new', [(new Map([["atome", "human"]]))], function $$11(params){var $a;
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,[]=,identity_generator,merge,reject,has_key?,to_sym,include?,==,reorder_particles,new,to_proc,atome_common,preset_common');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
...
Opal.modules["atome/genesis/particles/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,connect,html,to_proc,database_ready,instance_of?,length,messages,[]=,store_messages,send_message,puts,controller_sender,[],int8');
...
Opal.modules["atome/genesis/particles/hierarchy"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attach,grab,delete,attached,==,attached=,include?,push,detach_child,render,to_proc,new,attachment_common,instance_of?,each,<<,puts,affect,id,instance_variable_get,instance_variable_set,remove,apply,detach_atome');
...
Opal.modules["atome/genesis/particles/material"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $send(self, 'new', [(new Map([["after", "pattern"]]))], function $$16(params){var self = $$16.$$s == null ? this : $$16.$$s, a = nil;
...
Opal.modules["atome/genesis/particles/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('match,to_i,[],to_f,new,dup,affect,each,apply,grab,id,[]=,data,keys,insert,nil?,puts,sort_by!,values,-,instance_of?,to_s,is_a?,respond_to?');
  ...
  $send(self, 'new', [(new Map([["particle", "insert"], ["category", "property"], ["type", "string"]]))], function $$15(params){var self = $$15.$$s == null ? this : $$15.$$s, content = nil, cell = nil, row_nb = nil, column_nb = nil, position_to_insert = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "sort"], ["category", "property"], ["type", "int"]]))], function $$16(params){var self = $$16.$$s == null ? this : $$16.$$s, column = nil, method = nil;
...
Opal.modules["atome/utilities/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$refresh', function $$refresh() {
      ...
      $send(particles_found, 'each', [], function $$9(particle_found, value_found){var self = $$9.$$s == null ? this : $$9.$$s;

        
        if (particle_found == null) particle_found = nil;
        if (value_found == null) value_found = nil;
        return self.$send(particle_found, value_found);}, {$$s: self});
      return $send(self.$color(), 'each', [], function $$10(col){var self = $$10.$$s == null ? this : $$10.$$s;
    ...
    $def(self, '$each_with_index', function $$each_with_index() {
      ...
      ;
      index = 0;
      return $send(self.$collect(), 'each', [], function $$12(val){var self = $$12.$$s == null ? this : $$12.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$13(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$14(value) {
      var self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$15(particle, value){var self = $$15.$$s == null ? this : $$15.$$s;
    ...
    $def(self, '$get_localstorage_content', function $$get_localstorage_content() {
      ...
      $send(storage_array, 'each_with_index', [], function $$16(_i, index){var $a, key = nil, value = nil;
    ...
    $def(self, '$send_localstorage_content', function $$send_localstorage_content() {
      ...
      storage = $$('JS').$global()['$[]']("localStorage");
      storage_array = storage.$to_a();
      return $send(storage_array, 'each_with_index', [], function $$17(_i, index){var self = $$17.$$s == null ? this : $$17.$$s, key = nil, value = nil;

        
        if (_i == null) _i = nil;
        if (index == null) index = nil;
        key = $$('JS').$global()['$[]']("localStorage").$key(index);
        return (value = self.$sanitize_data_for_json($$('JS').$global()['$[]']("localStorage").$getItem(key)));}, {$$s: self});
    });
    
    $def(self, '$to_sym', function $$to_sym() {
      var self = this;

      
      self.$puts("sanitizer temp patch when an atome is passed instead of an id");
      return self.id;
    });
    return $def(self, '$sync', function $$sync(params) {
...
Opal.modules["renderers/html/hierarchy"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,append_to,html,type,each,shadow,grab,*,red,green,blue,alpha,left,top,[],blur,invert,==,option,<<,join,style,paint,diffusion,direction,params,rotate,gradient,last,border,thickness,pattern,colorize_svg_data');
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"]]))], function $$2(parent_found, _user_proc){var self = $$2.$$s == null ? this : $$2.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      ...
      case "border":
        return $send(self.$border(), 'each', [], function $$6(border_id_found){var self = $$6.$$s == null ? this : $$6.$$s, border_found = nil, thickness = nil, pattern = nil;
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"], ["specific", "text"]]))], function $$7(parent_found, _user_proc){var self = $$7.$$s == null ? this : $$7.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      case "shadow":
        ...
        shadows_to_apply = (new Map([["filter", []], ["boxShadow", []]]));
        $send(self.$shadow(), 'each', [], function $$8(shadow_id_found){var self = $$8.$$s == null ? this : $$8.$$s, shadow_found = nil, red = nil, green = nil, blue = nil, alpha = nil, left = nil, top = nil, blur = nil, inset = nil;
      ...
      case "paint":
        ...
        gradients_to_apply = [];
        $send(self.$paint(), 'each', [], function $$9(paint_id){var self = $$9.$$s == null ? this : $$9.$$s, colors_to_apply = nil, paint_atome = nil, paint_diffusion = nil, paint_direction = nil, diffusion = nil, $ret_or_2 = nil, direction = nil;
          ...
          $send(paint_atome.$gradient(), 'each', [], function $$10(color_id){var self = $$10.$$s == null ? this : $$10.$$s, color_found = nil;
  ...
  return $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"], ["specific", "vector"]]))], function $$11(parent_found, _user_proc){var self = $$11.$$s == null ? this : $$11.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      case "shadow":
        ...
        shadows_to_apply = (new Map([["filter", []], ["boxShadow", []]]));
        $send(self.$shadow(), 'each', [], function $$12(shadow_id_found){var self = $$12.$$s == null ? this : $$12.$$s, shadow_found = nil, red = nil, green = nil, blue = nil, alpha = nil, left = nil, top = nil, blur = nil, inset = nil;
      ...
      case "paint":
        ...
        gradients_to_apply = [];
        $send(self.$paint(), 'each', [], function $$13(paint_id){var self = $$13.$$s == null ? this : $$13.$$s, colors_to_apply = nil, paint_atome = nil, paint_diffusion = nil, paint_direction = nil, diffusion = nil, $ret_or_2 = nil, direction = nil;
          ...
          $send(paint_atome.$gradient(), 'each', [], function $$14(color_id){var self = $$14.$$s == null ? this : $$14.$$s, color_found = nil;
...
Opal.modules["renderers/html/html"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$remove', function $$remove(params) {try { var $t_return = $thrower('return'); 
      ...
      if ($eqeqeq($$('Hash'), ($ret_or_1 = params))) {
        return $send(params, 'each', [], function $$59(k, v){var self = $$59.$$s == null ? this : $$59.$$s, row_index = nil, table_element = nil, rows = nil, row_to_remove = nil, column_index = nil;
          if (self.id == null) self.id = nil;
          ...
          switch (k.valueOf()) {
            case "row":
              ...
              if ($truthy(table_element['$nil?']())) {
                ...
                self.$puts("Table not found");
                $t_return.$throw(nil, $$59.$$is_lambda);
              };
              ...
              return $send(rows, 'each_with_index', [], function $$60(row, i){
            ...
            case "column":
              ...
              rows = table_element.$querySelectorAll("tbody tr").$to_a();
              return $send(rows, 'each', [], function $$61(row){var cells = nil, cell_to_remove = nil;
    ...
    $def(self, '$center', function $$center(options, attach) {
      ...
      if ($truthy(self.center_options['$[]']("dynamic"))) {
        ...
        event_handler = $lambda(function $$62(event){var self = $$62.$$s == null ? this : $$62.$$s;
...
Opal.modules["renderers/html/material"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$new((new Map([["method", "pattern"], ["type", "integer"], ["renderer", "html"]])));
};

Opal.modules["renderers/html/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('new,attr,html,update_data,table_clean,table_insert,remove,refresh_table');
  ...
  return $send(self, 'new', [(new Map([["method", "sort"], ["renderer", "html"], ["type", "hash"]]))], function $$9(params){var self = $$9.$$s == null ? this : $$9.$$s;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,identity_generator,current_machine=,puts,aui,app_identity,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,atome_infos,server,init_websocket,sync,==,database_ready=,particle_list,each,send_localstorage_content,password');
  ...
  $def(self, '$atome_genesis', function $$atome_genesis() {
    ...
    return $send($$('A'), 'init_websocket', [], function $$4(msg){var self = $$4.$$s == null ? this : $$4.$$s;
      ...
      if (msg == null) msg = nil;
      return self.$puts("websocket initailsaed " + (msg));}, {$$s: self});
  });
  ...
  $def(self, '$init_database', function $$init_database() {
    ...
    $send($$('A'), 'sync', [(new Map([["action", "init_db"], ["data", (new Map([["database", "eDen"]]))]]))], function $$5(data){var $a;
      ...
      if ($eqeq(data['$[]']("data")['$[]']("message"), "database_ready")) {
        return ($a = [true], $send($$('Universe'), 'database_ready=', $a), $a[$a.length - 1])
      } else {
        return ($a = [false], $send($$('Universe'), 'database_ready=', $a), $a[$a.length - 1])
      };});
    ...
    $send($$('A'), 'sync', [(new Map([["action", "crate_db_table"], ["data", (new Map([["table", "user"], ["type", "string"]]))]]))], function $$6(_db_state){
      ...
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'sync', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "user"], ["column", "email"], ["type", "string"]]))]]))], function $$7(_db_state){
    ...
    $send(particles, 'each', [], function $$15(particle, infos){var type = nil;
      ...
      return $send($$('A'), 'sync', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "atome"], ["column", particle], ["type", type]]))]]))], function $$16(_db_state){
        ...
        if (_db_state == null) _db_state = nil;
        return nil;});});
    self.$puts("now we send localstorage  send_localstorage_content to the server");
    return self.$send_localstorage_content();
  });

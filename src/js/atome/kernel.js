...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.5.9.1")
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('include,[],identity_generator,new,[]=,to_h,map,reject,include?,merge,collapse,object,html,particle_main,to_proc,instance_variable_set,particle_pre,particle_callback,store_proc,render,particle_post,particle_after,instance_variables,==,join,inspect,instance_variable_get,class');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$initialize', function $$initialize(new_atome) {
      ...
      ordered_keys = ["renderers", "id", "alien", "type", "int8", "unit"];
...
Opal.modules["atome/genesis/generators/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,instance_of?,connect,html,[],to_proc,[]=,current_user,password,send_message,controller_sender,int8');
  ...
  $send(self, 'new', [(new Map([["particle", "controller"]]))], function $$3(msg){
    
    if (msg == null) msg = nil;
    return $$('Atome').$controller_sender(msg);});
  self.$new((new Map([["particle", "int8"]])));
  return $send(self, 'new', [(new Map([["particle", "language"]]))], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s;
...
Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$new((new Map([["particle", "left"]])));
  self.$new((new Map([["particle", "right"]])));
  self.$new((new Map([["particle", "top"]])));
  self.$new((new Map([["particle", "bottom"]])));
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$new((new Map([["particle", "metrics"], ["type", "hash"]])));
...
Opal.modules["renderers/html/geometry"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,[],metrics,style,html,is_a?');
  ...
  $send(self, 'new', [(new Map([["method", "height"], ["renderer", "html"], ["type", "string"]]))], function $$2(value, _user_proc){var self = $$2.$$s == null ? this : $$2.$$s, unit_found = nil;
    ...
    if (value == null) value = nil;
    if (_user_proc == null) _user_proc = nil;
    unit_found = self.$metrics()['$[]']("height");
    if ($truthy(unit_found)) {
...
Opal.modules["renderers/html/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $return_val = Opal.return_val, $truthy = Opal.truthy, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('new,shape,html,svg,image,video,www,raw,text,add_class,[]=,language,to_s,[],int8,js,svg_data,each,send,update_svg_data,path,raw_data,table,atomized,alien');
  ...
  $send(self, 'new', [(new Map([["method", "data"], ["type", "string"], ["specific", "text"], ["renderer", "html"]]))], function $$9(params){var $a, self = $$9.$$s == null ? this : $$9.$$s;
    ...
    if (params == null) params = nil;
    return ($a = ["innerHTML", ($truthy(self.$language()) ? (self.$int8()['$[]'](self.$language()).$to_s()) : (params.$to_s()))], $send(self.$js(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
...
Opal.modules["renderers/html/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,attr,html,update_data,[],*,red,green,blue,alpha,style,table_clean,table_insert,table_remove,refresh_table,each,[]=,send');
  ...
  $send(self, 'new', [(new Map([["method", "sort"], ["renderer", "html"], ["type", "hash"]]))], function $$10(params){var self = $$10.$$s == null ? this : $$10.$$s;

    
    if (params == null) params = nil;
    return self.$html().$refresh_table(params);}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "unit"], ["store", false]]))], function $$11(params){var self = $$11.$$s == null ? this : $$11.$$s;
    if (self.unit == null) self.unit = nil;

    
    if (params == null) params = nil;
    $send(params, 'each', [], function $$12(k, v){var self = $$12.$$s == null ? this : $$12.$$s;
      if (self.unit == null) self.unit = nil;
...
Opal.modules["renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,[],[]=,js,transform,html,style,center,attach');
  ...
  $send(self, 'new', [(new Map([["method", "rotate"], ["type", "integer"], ["renderer", "html"]]))], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s;

    
    if (params == null) params = nil;
    return self.$html().$transform("rotate", params);}, {$$s: self});
  self.$new((new Map([["method", "rotate"], ["type", "integer"], ["renderer", "html"], ["specific", "paint"]])));
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "position"]]))], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("position", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "depth"]]))], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("z-index", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "organise"], ["renderer", "html"]]))], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("gridTemplateColumns", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "spacing"], ["renderer", "html"]]))], function $$9(params){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("gap", "" + (params) + "px");}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "display"], ["renderer", "html"]]))], function $$10(params){var self = $$10.$$s == null ? this : $$10.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("display", params);}, {$$s: self});
  return $send(self, 'new', [(new Map([["renderer", "html"], ["method", "center"]]))], function $$11(params){var self = $$11.$$s == null ? this : $$11.$$s;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help');
  ...
  self.$human((new Map([["id", "anonymous"], ["login", true], ["password", user_password], ["data", (new Map([["birthday", "10/05/1996"]]))], ["selection", []], ["attach", "user_view"]])));
  ...
  return $send($$('A'), 'example', ["left"], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s, english = nil, french = nil, code = nil, example = nil, code_text = nil;

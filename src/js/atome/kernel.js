...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.6.6")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attr_reader,attr_accessor,[]=,[],delete,instance_variable_get,to_sym,merge!,push,+,each,tag,<<,id,gsub,uuid,strftime,now,generate_uuid,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,%,setItem,length');
  return (function($base, $super, $parent_nesting) {
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$inspect', function $$inspect() {
      ...
      filtered_vars = $send(self.$instance_variables(), 'reject', [], function $$2(var$){var $ret_or_1 = nil;
      ...
      content = $send(filtered_vars, 'map', [], function $$3(var$){var self = $$3.$$s == null ? this : $$3.$$s;
...
Opal.modules["atome/genesis/particles/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,to_sym,instance_of?,each,<<,grab,collect=,==,selection,current_user,delete,collect');

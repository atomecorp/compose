...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.6.4")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attr_reader,attr_accessor,[]=,[],delete,instance_variable_get,to_sym,merge!,push,+,each,tag,<<,gsub,uuid,strftime,now,generate_uuid,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,%,setItem,length');
  return (function($base, $super, $parent_nesting) {
...
Opal.modules["atome/utilities/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $eqeq = Opal.eqeq, $gvars = Opal.gvars, $thrower = Opal.thrower, $slice = Opal.slice, $truthy = Opal.truthy, $to_a = Opal.to_a, $defs = Opal.defs, $hash_rehash = Opal.hash_rehash, $not = Opal.not, $range = Opal.range, $rb_plus = Opal.rb_plus, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('require,attr_accessor,instance_exec,grab,to_proc,==,to_json,inspect,eval,each,method,define_singleton_method,instance_variable_get,empty?,instance_variable_set,[],is_a?,call,set_help,get_help,set_example,get_example,send,atome_js,initialized,<<,!,instance_of?,get_sanitizer_method,particle_sanitizer,atome_common,atome_pre_process,atome_post_process,story,[]=,define_method,first,values,atome,each_with_object,instance_variables,to_sym,include?,delete,to_s,particles_to_hash,color,apply,collect,+,puts,users,current_user=,debug,display,attach,remove,category,length,attached,messages,connection,global,to_a,each_with_index,key,getItem,gsub,sanitize_data_for_json,store_messages,send_message,html');
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$collapse', function $$collapse(new_atome) {
      ...
      $send(new_atome, 'each', [], function $$4(element, value){var self = $$4.$$s == null ? this : $$4.$$s, initialized_proc = nil;
      ...
      return $send(initialized_procs, 'each', [], function $$5(value){var self = $$5.$$s == null ? this : $$5.$$s;

        
        if (value == null) value = nil;
        return $send(value, 'each', [], function $$6(val, proc){var self = $$6.$$s == null ? this : $$6.$$s;
    ...
    $def(self, '$particle_callback', function $$particle_callback(element) {
      ...
      return $send($$('Atome'), 'define_method', ["" + (element) + "_callback"], function $$7(return_params){var self = $$7.$$s == null ? this : $$7.$$s, proc_found = nil;
    ...
    $def(self, '$particles', function $$particles(particles_found) {
      ...
      if ($truthy(particles_found)) {
        return $send(particles_found, 'each', [], function $$8(particle_found, value_found){var $a, self = $$8.$$s == null ? this : $$8.$$s;
    ...
    $def(self, '$atome', function $$atome() {
      ...
      return $send(self.$instance_variables(), 'each_with_object', [(new Map())], function $$9(var$, hash){var $a, self = $$9.$$s == null ? this : $$9.$$s;
    ...
    $def(self, '$particles_to_hash', function $$particles_to_hash() {
      ...
      hash = (new Map());
      $send(self.$instance_variables(), 'each', [], function $$10(var$){var $a, self = $$10.$$s == null ? this : $$10.$$s;
    ...
    $def(self, '$refresh', function $$refresh() {
      ...
      $send(particles_found, 'each', [], function $$11(particle_found, value_found){var self = $$11.$$s == null ? this : $$11.$$s;

        
        if (particle_found == null) particle_found = nil;
        if (value_found == null) value_found = nil;
        return self.$send(particle_found, value_found);}, {$$s: self});
      return $send(self.$color(), 'each', [], function $$12(col){var self = $$12.$$s == null ? this : $$12.$$s;
    ...
    $def(self, '$each', function $$each() {
      ...
      ;
      return $send(self.$collect(), 'each', [], function $$13(val){var self = $$13.$$s == null ? this : $$13.$$s;
    ...
    $def(self, '$each_with_index', function $$each_with_index() {
      ...
      ;
      index = 0;
      return $send(self.$collect(), 'each', [], function $$14(val){var self = $$14.$$s == null ? this : $$14.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$15(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$16(value) {
      var self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$17(particle, value){var self = $$17.$$s == null ? this : $$17.$$s;
    ...
    $def(self, '$get_localstorage_content', function $$get_localstorage_content() {
      ...
      $send(storage_array, 'each_with_index', [], function $$18(_i, index){var $a, key = nil, value = nil;
    ...
    $def(self, '$send_localstorage_content', function $$send_localstorage_content() {
      ...
      storage = $$('JS').$global()['$[]']("localStorage");
      storage_array = storage.$to_a();
      return $send(storage_array, 'each_with_index', [], function $$19(_i, index){var self = $$19.$$s == null ? this : $$19.$$s, key = nil, value = nil;
...
Opal.modules["atome/genesis/particles/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('match,to_i,[],to_f,new,dup,affect,each,apply,grab,id,[]=,data,keys,insert,nil?,puts,sort_by!,values,-,instance_of?,to_s,is_a?,respond_to?,render,to_proc');
  ...
  return $send(self, 'new', [(new Map([["initialized", "inside"]]))], function $$19(params){var user_proc = $$19.$$p || nil, self = $$19.$$s == null ? this : $$19.$$s;
...
Opal.modules["renderers/html/html"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$fill', function $$fill(params) {
      ...
      $send(elements_to_remove, 'each', [], function $$16(child){var self = $$16.$$s == null ? this : $$16.$$s;
        if (self.element == null) self.element = nil;

        
        if (child == null) child = nil;
        return self.element.$removeChild(child);}, {$$s: self});
      return $send(params, 'each', [], function $$17(param){var self = $$17.$$s == null ? this : $$17.$$s, background_layer = nil, atome_path = nil, img_width = nil, img_height = nil;
    ...
    $def(self, '$animation_frame_callback', function $$animation_frame_callback(proc_pass, play_content) {
      ...
      return $$('JS').$global()['$[]']("window").$requestAnimationFrame($lambda(function $$18(timestamp){var self = $$18.$$s == null ? this : $$18.$$s, current_time = nil, fps = nil, current_frame = nil;
        if (self.element == null) self.element = nil;
        if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$delete', function $HTML_delete$19(id_to_delete) {
    ...
    $def(self, '$on', function $$on(property, _option) {
      ...
      if ($truthy(property['$start_with?']("media:"))) {
        ...
        event_handler = $lambda(function $$21(event){var width = nil, height = nil;
        ...
        event_handler = $lambda(function $$22(event){
    ...
    $def(self, '$keyboard_press', function $$keyboard_press(_option) {
      ...
      keypress_handler = $lambda(function $$23(native_event){var self = $$23.$$s == null ? this : $$23.$$s, event = nil;
    ...
    $def(self, '$keyboard_down', function $$keyboard_down(_option) {
      ...
      keypress_handler = $lambda(function $$24(event){var self = $$24.$$s == null ? this : $$24.$$s;
    ...
    $def(self, '$drag_start', function $$drag_start(_option) {try { 
      ...
      return $send(interact, 'on', ["dragstart"], function $$26(native_event){var self = $$26.$$s == null ? this : $$26.$$s, event = nil;
    ...
    $def(self, '$drag_end', function $$drag_end(_option) {try { 
      ...
      return $send(interact, 'on', ["dragend"], function $$27(native_event){var self = $$27.$$s == null ? this : $$27.$$s, event = nil;
    ...
    $def(self, '$drag_move', function $$drag_move(_option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$28(native_event){var self = $$28.$$s == null ? this : $$28.$$s, event = nil, dx = nil, dy = nil, x = nil, $ret_or_1 = nil, y = nil;
    ...
    $def(self, '$drag_restrict', function $$drag_restrict(option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$29(native_event){var self = $$29.$$s == null ? this : $$29.$$s, event = nil, dx = nil, dy = nil, x = nil, y = nil, restricted_x = nil, restricted_y = nil;
        if (self.drag_move == null) self.drag_move = nil;
        if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$drag_locked', function $$drag_locked(_option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$30(native_event){var self = $$30.$$s == null ? this : $$30.$$s, event = nil;
    ...
    $def(self, '$drop_activate', function $$drop_activate(_option) {try { 
      ...
      return interact.$dropzone((new Map([["accept", nil], ["overlap", 0.75], ["ondropactivate", $send(self, 'lambda', [], function $$31(native_event){var self = $$31.$$s == null ? this : $$31.$$s;
    ...
    $def(self, '$drop_deactivate', function $$drop_deactivate(_option) {try { 
      ...
      return interact.$dropzone((new Map([["ondropdeactivate", $send(self, 'lambda', [], function $$32(native_event){var self = $$32.$$s == null ? this : $$32.$$s;
    ...
    $def(self, '$drop_dropped', function $$drop_dropped(_option) {try { 
      ...
      interact = $$('JS').$eval("return interact('#" + (self.id) + "')");
      return interact.$dropzone((new Map([["overlap", 0.75], ["ondrop", $send(self, 'lambda', [], function $$33(native_event){var self = $$33.$$s == null ? this : $$33.$$s;
    ...
    $def(self, '$drop_enter', function $$drop_enter(_option) {try { 
      ...
      return interact.$dropzone((new Map([["overlap", 0.001], ["ondragenter", $send(self, 'lambda', [], function $$34(native_event){var self = $$34.$$s == null ? this : $$34.$$s;
    ...
    $def(self, '$drop_leave', function $$drop_leave(_option) {try { 
      ...
      return interact.$dropzone((new Map([["ondragleave", $send(self, 'lambda', [], function $$35(native_event){var self = $$35.$$s == null ? this : $$35.$$s;
    ...
    $def(self, '$resize', function $$resize(params, options) {try { 
      ...
      if ($eqeq(params, "remove")) {
        ...
        return interact.$resizable((new Map([["edges", (new Map([["left", true], ["right", true], ["top", true], ["bottom", true]]))], ["inertia", true], ["modifiers", []], ["listeners", (new Map([["move", $send(self, 'lambda', [], function $$36(native_event){var self = $$36.$$s == null ? this : $$36.$$s, event = nil, x = nil, y = nil, width = nil, height = nil;
          if (self.resize == null) self.resize = nil;
          if (self.element == null) self.element = nil;
          if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$overflow', function $$overflow(params, bloc) {
      ...
      return self.element.$addEventListener("scroll", $send(self, 'lambda', [], function $$37(event){var self = $$37.$$s == null ? this : $$37.$$s, scroll_top = nil, scroll_left = nil;
        if (self.element == null) self.element = nil;
    ...
    $def(self, '$over_over', function $$over_over(_option) {try { 
      ...
      return $send(interact, 'on', ["mouseover"], function $$38(native_event){var self = $$38.$$s == null ? this : $$38.$$s, event = nil;
        if (self.id == null) self.id = nil;
        if (self.over_over == null) self.over_over = nil;

        
        if (native_event == null) native_event = nil;
        $$('JS').$global()['$[]=']("myRubyMouseOverCallback", $send($$('Proc'), 'new', [], function $$39(){var self = $$39.$$s == null ? this : $$39.$$s;
          if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$over_enter', function $$over_enter(_option) {
      ...
      self.over_enter_callback = $send(self, 'lambda', [], function $$40(event){var self = $$40.$$s == null ? this : $$40.$$s;
    ...
    $def(self, '$over_leave', function $$over_leave(_option) {
      ...
      self.over_leave_callback = $send(self, 'lambda', [], function $$41(event){var self = $$41.$$s == null ? this : $$41.$$s;
    ...
    $def(self, '$touch_tap', function $$touch_tap(_option) {try { 
      ...
      if ($truthy(self.touch_removed['$[]']("tap"))) {
        ...
        return $send(interact, 'on', ["tap"], function $$42(native_event){var self = $$42.$$s == null ? this : $$42.$$s, event = nil;
    ...
    $def(self, '$touch_double', function $$touch_double(_option) {try { 
      ...
      if ($truthy(self.touch_removed['$[]']("double"))) {
        ...
        return $send(interact, 'on', ["doubletap"], function $$43(native_event){var self = $$43.$$s == null ? this : $$43.$$s, event = nil;
    ...
    $def(self, '$touch_long', function $$touch_long(_option) {try { 
      ...
      if ($truthy(self.touch_removed['$[]']("long"))) {
        ...
        return $send(interact, 'on', ["hold"], function $$44(native_event){var self = $$44.$$s == null ? this : $$44.$$s, event = nil;
    ...
    $def(self, '$touch_down', function $$touch_down(_option) {try { 
      ...
      if ($truthy(self.touch_removed['$[]']("down"))) {
        ...
        return $send(interact, 'on', ["down"], function $$45(native_event){var self = $$45.$$s == null ? this : $$45.$$s, event = nil;
    ...
    $def(self, '$touch_up', function $$touch_up(_option) {try { 
      ...
      if ($truthy(self.touch_removed['$[]']("up"))) {
        ...
        return $send(interact, 'on', ["up"], function $$46(native_event){var self = $$46.$$s == null ? this : $$46.$$s, event = nil;
    ...
    $def(self, '$update_data', function $$update_data(params) {
      ...
      self.input_listener = ($truthy(($ret_or_1 = self.input_listener)) ? ($ret_or_1) : ($send(self, 'lambda', [], function $$47(event){var self = $$47.$$s == null ? this : $$47.$$s;
    ...
    $def(self, '$table', function $$table(data) {
      ...
      max_length = $send(data, 'max_by', [], function $$48(row){
      ...
      if ($truthy(self.original_atome.$option()['$[]']("header"))) {
        ...
        $send(max_length, 'times', [], function $$49(i){var th = nil, $ret_or_1 = nil;

          
          if (i == null) i = nil;
          th = $$('JS').$global()['$[]']("document").$createElement("th");
          th['$[]=']("textContent", ($truthy(($ret_or_1 = $send(data, 'map', [], function $$50(row){
      ...
      $send(data, 'each_with_index', [], function $$51(row, row_index){var self = $$51.$$s == null ? this : $$51.$$s, tr = nil;

        
        if (row == null) row = nil;
        if (row_index == null) row_index = nil;
        tr = $$('JS').$global()['$[]']("document").$createElement("tr");
        $send(max_length, 'times', [], function $$52(cell_index){var self = $$52.$$s == null ? this : $$52.$$s, td = nil, cell_size = nil, cell_height = nil, cell_value = nil, html_element = nil;
    ...
    $def(self, '$refresh_table', function $$refresh_table(_params) {
      ...
      $send(data, 'each', [], function $$53(row){
        
        if (row == null) row = nil;
        return $send(row, 'each', [], function $$54(k, v){
      ...
      $send($rb_minus(table_element['$[]']("rows").$to_a().$length(), 1), 'downto', [1], function $$55(i){
        
        if (i == null) i = nil;
        return table_element.$deleteRow(i);});
      max_cells = $send(data, 'map', [], function $$56(row){
        
        if (row == null) row = nil;
        return row.$keys().$length();}).$max();
      return $send(data, 'each', [], function $$57(row){var self = $$57.$$s == null ? this : $$57.$$s, new_row = nil;

        
        if (row == null) row = nil;
        new_row = table_element.$insertRow(-1);
        return $send(max_cells, 'times', [], function $$58(i){var self = $$58.$$s == null ? this : $$58.$$s, key = nil, value = nil, cell = nil, html_element = nil;
    ...
    $def(self, '$insert_row', function $$insert_row(params) {
      ...
      $send(column_count, 'times', [], function $$59(cell_index){var self = $$59.$$s == null ? this : $$59.$$s, td = nil;
    ...
    $def(self, '$insert_column', function $$insert_column(params) {
      ...
      return $send(rows, 'each_with_index', [], function $$60(row, index){var self = $$60.$$s == null ? this : $$60.$$s, new_cell = nil, child_nodes = nil, reference_cell = nil;
    ...
    $def(self, '$remove', function $$remove(params) {try { var $t_return = $thrower('return'); 
      ...
      if ($eqeqeq($$('Hash'), ($ret_or_1 = params))) {
        return $send(params, 'each', [], function $$61(k, v){var self = $$61.$$s == null ? this : $$61.$$s, row_index = nil, table_element = nil, rows = nil, row_to_remove = nil, column_index = nil;
          if (self.id == null) self.id = nil;
          ...
          switch (k.valueOf()) {
            case "row":
              ...
              if ($truthy(table_element['$nil?']())) {
                ...
                self.$puts("Table not found");
                $t_return.$throw(nil, $$61.$$is_lambda);
              };
              ...
              return $send(rows, 'each_with_index', [], function $$62(row, i){
            ...
            case "column":
              ...
              rows = table_element.$querySelectorAll("tbody tr").$to_a();
              return $send(rows, 'each', [], function $$63(row){var cells = nil, cell_to_remove = nil;
    ...
    $def(self, '$center', function $$center(options, attach) {
      ...
      if ($truthy(self.center_options['$[]']("dynamic"))) {
        ...
        event_handler = $lambda(function $$64(event){var self = $$64.$$s == null ? this : $$64.$$s;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $a, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,identity_generator,current_machine=,puts,aui,app_identity,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,atome_infos,server,init_websocket,sync,==,database_ready=,particle_list,each,send_localstorage_content,password,allow_history=');
  ...
  return ($a = [true], $send($$('Universe'), 'allow_history=', $a), $a[$a.length - 1]);
};

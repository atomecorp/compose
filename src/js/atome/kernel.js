...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.5.8.7")
...
Opal.modules["atome/genesis/genesis"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('define_method,particle_creation,to_proc,[],nil?,add_to_particle_list,auto_render_generator,new_particle,additional_particle_methods,add_to_atome_list,atome_method_for_object,default_params,new_default_params,new_atome,each,renderer_list,build_render,is_a?,instance_exec,add_sanitizer_method,to_sym,add_optional_method,[]=,write_auth,==,particle_sanitizer,create_particle,!,include?,collect,send,grab,historicize,read_auth,instance_variable_get,particle_read,atome_sanitizer,atome_processor,apply,type,<<,attached,new');
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      $def(self, '$new_particle', function $$new_particle(element, store, render) {
        ...
        return $send($$('Atome'), 'define_method', [element], function $$4(params){var user_proc = $$4.$$p || nil, self = $$4.$$s == null ? this : $$4.$$s, $ret_or_1 = nil, computed_params = nil, value_found = nil;
          ...
          if ((($truthy(params) || ($eqeq(params, false))) && ($truthy(self.$write_auth(element))))) {
            ...
            $$('Universe').$historicize(self.id, "write", element, params);
      ...
      return $def(self, '$new_atome', function $$new_atome(element) {
        ...
        $send($$('Atome'), 'define_method', [element], function $$7(params){var user_proc = $$7.$$p || nil, self = $$7.$$s == null ? this : $$7.$$s, collected_atomes = nil;
          ...
          if ($truthy(params)) {
            ...
            collected_atomes = [];
            if ($truthy(["color", "shadow", "paint"]['$include?'](element))) {
        ...
        return $send($$('Atome'), 'define_method', ["set_" + (element)], function $$10(params){var user_proc = $$10.$$p || nil;
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $slice = Opal.slice, $send = Opal.send, $def = Opal.def, $return_ivar = Opal.return_ivar, $hash_rehash = Opal.hash_rehash, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $assign_ivar_val = Opal.assign_ivar_val, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $assign_ivar = Opal.assign_ivar, $neqeq = Opal.neqeq, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('attr_reader,[]=,instance_variable_get,to_sym,[],merge!,push,+,delete,each,tag,<<,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,length,now');
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      self.$attr_reader("atomes", "renderer_list", "atome_list", "particle_list", "classes", "counter", "atomes_specificities");
      ...
      $def(self, '$add_sanitizer_method', function $$add_sanitizer_method(method_name) {
        ...
        ;
        return self.$instance_variable_get("@sanitizers")['$merge!']($hash_rehash(new Map([[method_name, method_proc]])));
      });
      ...
      $def(self, '$historicize', function $$historicize(id, operation, element, params) {
        ...
        return ($a = [self.history.$length(), $hash_rehash(new Map([[id, $hash_rehash(new Map([[operation, $hash_rehash(new Map([[element, params]]))]]))], ["sync", false], ["time", $$('Time').$now()]]))], $send(self.history, '[]=', $a), $a[$a.length - 1])
      });
      return $def(self, '$story', function $$story(filter) {
        var self = this, operation = nil, atome_id = nil, particle = nil, filtered_history = nil;
        if (self.history == null) self.history = nil;
        ...
        filtered_history = [];
        $send(self.history, 'each', [], function $$5(operation_number, alteration){
          
          if (operation_number == null) operation_number = nil;
          if (alteration == null) alteration = nil;
          if ((($truthy(alteration['$[]'](atome_id)) && ($truthy(alteration['$[]'](atome_id)['$[]'](operation)))) && ($truthy(alteration['$[]'](atome_id)['$[]'](operation)['$[]'](particle))))) {
            return filtered_history['$<<']($hash_rehash(new Map([["operation", operation_number], [filter['$[]']("particle"), alteration['$[]'](atome_id)['$[]'](operation)['$[]'](particle)], ["sync", alteration['$[]']("sync")], ["time", alteration['$[]']("time")]])))
          } else {
            return nil
          };});
...
Opal.modules["atome/helpers/essentials"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $parent_nesting) {
    ...
    self.default_params = (new Map([["render_engines", ["html"]], ["image", (new Map([["type", "image"], ["left", 0], ["top", 0]]))], ["matrix", (new Map([["type", "matrix"], ["left", 0], ["top", 0], ["option", (new Map())]]))], ["video", (new Map([["type", "video"]]))], ["animation", (new Map([["type", "animation"], ["attach", "black_matter"]]))], ["element", (new Map([["type", "element"], ["renderers", []], ["attach", "black_matter"]]))], ["box", (new Map([["type", "shape"], ["width", 99], ["height", 99], ["apply", ["box_color"]], ["left", 100], ["top", 100], ["preset", "box"]]))], ["vector", (new Map([["type", "vector"], ["width", 99], ["height", 99], ["left", 100], ["top", 100], ["preset", "vector"], ["definition", corp]]))], ["circle", (new Map([["type", "shape"], ["width", 99], ["height", 99], ["smooth", "100%"], ["apply", ["circle_color"]], ["left", 100], ["top", 100], ["preset", "circle"]]))], ["shape", (new Map([["type", "shape"], ["width", 99], ["height", 99], ["apply", ["shape_color"]], ["left", 100], ["top", 100]]))], ["text", (new Map([["type", "text"], ["component", (new Map([["size", 18]]))], ["left", 0], ["top", 0], ["apply", ["text_color"]], ["width", "auto"], ["height", "auto"]]))], ["drm", (new Map([["type", "drm"], ["attach", "black_matter"]]))], ["shadow", (new Map([["type", "shadow"], ["red", 0], ["green", 0], ["blue", 0], ["alpha", 0]]))], ["color", (new Map([["type", "color"], ["red", 0], ["green", 0], ["blue", 0], ["alpha", 1]]))]]));
...
Opal.modules["atome/helpers/color_helper/color/rgb/metallic"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color/rgb/colors"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$require("atome/helpers/color_helper/color/rgb/colors.rb"+ '/../' + "metallic");
};

Opal.modules["atome/helpers/color_helper/color/rgb"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$require("atome/helpers/color_helper/color/rgb.rb"+ '/../' + "rgb/colors");
};

Opal.modules["atome/helpers/color_helper/color/cmyk"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color/grayscale"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color/hsl"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color/yiq"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color/css"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/helpers/color_helper/color"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/rgb");
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/cmyk");
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/grayscale");
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/hsl");
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/yiq");
  self.$require("atome/helpers/color_helper/color.rb"+ '/../' + "color/css");
  return (function(self, $parent_nesting) {
    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting);
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $def = Opal.def, $eqeq = Opal.eqeq, $rb_times = Opal.rb_times, $thrower = Opal.thrower, $rb_minus = Opal.rb_minus, $eqeqeq = Opal.eqeqeq, $gvars = Opal.gvars, $ensure_kwargs = Opal.ensure_kwargs, $get_kwarg = Opal.get_kwarg, $hash_get = Opal.hash_get, $rb_plus = Opal.rb_plus, $rb_gt = Opal.rb_gt, $rb_divide = Opal.rb_divide, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('key?,add_atomes_specificities,[],build_atome,to_proc,instance_variable_set,build_particle,build_sanitizer,set_atomes_specificities,[]=,build_render,define_method,call,delete,grab,counter,==,instance_of?,to_sym,atomes,box,circle,default_params,send,include?,eval,new,object_id,*,global,is_a?,instance_exec,<<,-,length,===,puts,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,particle_list,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,merge');
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$new', function $Object_new$1(params) {
      var bloc = $Object_new$1.$$p || nil, renderer_found = nil, render_method = nil, particle_targetted = nil;
      ...
      if ($truthy(params['$key?']("atome"))) {
        ...
        return $send($$('Genesis'), 'build_atome', [params['$[]']("atome")], bloc.$to_proc());
      } else if ($truthy(params['$key?']("particle"))) {
        
        $$('Atome').$instance_variable_set("@main_" + (params['$[]']("particle")), bloc);
        return $send($$('Genesis'), 'build_particle', [params['$[]']("particle"), (new Map([["render", params['$[]']("render")], ["return", params['$[]']("return")], ["store", params['$[]']("store")], ["type", params['$[]']("type")]]))], bloc.$to_proc());
      } else if ($truthy(params['$key?']("sanitizer"))) {
        return $send($$('Genesis'), 'build_sanitizer', [params['$[]']("sanitizer")], bloc.$to_proc())
      } else if ($truthy(params['$key?']("pre"))) {
        return $$('Atome').$instance_variable_set("@pre_" + (params['$[]']("pre")), bloc)
      } else if ($truthy(params['$key?']("post"))) {
        return $$('Atome').$instance_variable_set("@post_" + (params['$[]']("post")), bloc)
      } else if ($truthy(params['$key?']("after"))) {
        return $$('Atome').$instance_variable_set("@after_" + (params['$[]']("after")), bloc)
      } else if ($truthy(params['$key?']("read"))) {
        return $$('Atome').$instance_variable_set("@read_" + (params['$[]']("read")), bloc)
        ...
        return $send($$('Genesis'), 'build_render', [render_method], bloc.$to_proc());
      } else if ($truthy(params['$key?']("callback"))) {
        
        particle_targetted = params['$[]']("callback");
        return $send($$('Atome'), 'define_method', ["" + (particle_targetted) + "_callback"], function $$2(){
          return bloc.$call()});
      } else {
        return nil
      };
    ...
    $def(self, '$delete', function $Object_delete$3(atomes) {
      var self = this;

      return self.$grab("view").$delete(atomes)
    });
    
    $def(self, '$identity_generator', function $$identity_generator(type_needed) {
      
      
      if (type_needed == null) type_needed = "element";
      return "" + (type_needed) + "_" + ($$('Universe').$counter());
    }, -1);
    ...
    $def(self, '$grab', function $$grab(id_to_get) {
      ...
      if ($truthy(id_to_get['$instance_of?']($$('Array')))) {
        id_to_get = ""
      };
      id_to_get = id_to_get.$to_sym();
      return $$('Universe').$atomes()['$[]'](id_to_get);
    });
    ...
    $def(self, '$atome_method_for_object', function $$atome_method_for_object(element) {
      ...
      return $send($$('Object'), 'define_method', [element], function $$4(params){var user_proc = $$4.$$p || nil, self = $$4.$$s == null ? this : $$4.$$s, default_parent = nil, $ret_or_1 = nil;
    ...
    $def(self, '$tagged', function $$tagged(params) {
      ...
      if ($truthy(params['$instance_of?']($$('Hash')))) {
        $send(params, 'each', [], function $$5(tag_name, tag_value){
          
          if (tag_name == null) tag_name = nil;
          if (tag_value == null) tag_value = nil;
          return $send($$('Universe').$atomes(), 'each', [], function $$6(atomes_id_found, atomes_found){var $a;
        ...
        $send($$('Universe').$atomes(), 'each', [], function $$7(atomes_id_found, atomes_found){var $a;
    ...
    $def(self, '$shortcut', function $$shortcut($kwargs) {
      ...
      $send(element_ids, 'each', [], function $$8(element_id){var element = nil;
        ...
        if ($eqeq(element_id.$to_sym(), "all")) {
          ...
          $send(element, 'addEventListener', ["mouseenter"], function $$9(){
            return ($gvars.current_hovered_element = element_id)});
          return $send(element, 'addEventListener', ["mouseleave"], function $$10(){
            return ($gvars.current_hovered_element = nil)});
        };});
      return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["keydown"], function $$11(native_event){var self = $$11.$$s == null ? this : $$11.$$s, event = nil, key_pressed = nil, ctrl_pressed = nil, alt_pressed = nil, meta_pressed = nil, modifier_matched = nil, $ret_or_1 = nil, affect_condition = nil, exclude_condition = nil;
    ...
    $def(self, '$console', function $$console(debug) {try { 
      ...
      if ($truthy(debug)) {
        ...
        $send(console_top, 'touch', ["double"], function $$12(){
          
          console.$height(25);
          console.$bottom(0);
          return console.$top("auto");});
        console_top.$shadow((new Map([["id", "s1"], ["left", 0], ["top", 3], ["blur", 9], ["invert", false], ["red", 0], ["green", 0], ["blue", 0], ["alpha", 1]])));
        $send(console, 'drag', ["locked"], function $$13(event){var self = $$13.$$s == null ? this : $$13.$$s, dy = nil, y = nil, total_height = nil;
        ...
        $send(console_clear, 'touch', [true], function $$14(){
          return console_output.$data("")});
        return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["contextmenu"], function $$15(event){
        ...
        return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["contextmenu"], function $$16(native_event){var self = $$16.$$s == null ? this : $$16.$$s, event = nil;
    ...
    $def(self, '$importer_all', function $$importer_all() {try { 
      ...
      ;
      $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["dragover"], function $$17(native_event){var self = $$17.$$s == null ? this : $$17.$$s, event = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        return event.$preventDefault();}, {$$s: self});
      return $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["drop"], function $$18(native_event){var self = $$18.$$s == null ? this : $$18.$$s, event = nil, files = nil;
        ...
        if ($truthy($rb_gt(files['$[]']("length").$to_i(), 0))) {
          return $send(Opal.Range.$new(0,files['$[]']("length").$to_i(), true), 'each', [], function $$19(i){var self = $$19.$$s == null ? this : $$19.$$s, file = nil, reader = nil;
            ...
            $send(reader, 'addEventListener', ["load"], function $$20(){
              return proc.$call((new Map([["content", reader['$[]']("result").$to_s()], ["name", file['$[]']("name").$to_s()], ["type", file['$[]']("type").$to_s()], ["size", file['$[]']("size").$to_s()]])))});
            return $send(reader, 'addEventListener', ["error"], function $$21(){var self = $$21.$$s == null ? this : $$21.$$s;
    ...
    $def(self, '$exception_import', function $$exception_import(atome_id) {try { 
      ...
      if ($truthy($$('Universe').$user_atomes()['$include?'](atome_id.$to_sym()))) {
        ...
        $send(special_div, 'addEventListener', ["dragover"], function $$22(native_event){var self = $$22.$$s == null ? this : $$22.$$s, event = nil;
        ...
        $send(special_div, 'addEventListener', ["dragleave"], function $$23(native_event){var self = $$23.$$s == null ? this : $$23.$$s, event = nil;
          ...
          return event.$stopPropagation();}, {$$s: self});
        $send(special_div, 'addEventListener', ["drop"], function $$24(native_event){var self = $$24.$$s == null ? this : $$24.$$s, event = nil, files = nil;
          ...
          files = event['$[]']("dataTransfer")['$[]']("files");
          if ($truthy($rb_gt(files['$[]']("length").$to_i(), 0))) {
            return $send(Opal.Range.$new(0,files['$[]']("length").$to_i(), true), 'each', [], function $$25(i){var self = $$25.$$s == null ? this : $$25.$$s, file = nil, reader = nil;
              ...
              reader = $$('JS').$eval("let a= new FileReader(); return a");
              reader.$readAsText(file);
              $send(reader, 'addEventListener', ["load"], function $$26(){
                return proc.$call((new Map([["content", reader['$[]']("result").$to_s()], ["name", file['$[]']("name").$to_s()], ["type", file['$[]']("type").$to_s()], ["size", file['$[]']("size").$to_s()]])))});
              return $send(reader, 'addEventListener', ["error"], function $$27(){var self = $$27.$$s == null ? this : $$27.$$s;

                return self.$puts($rb_plus("Error: ", file['$[]']("name").$to_s()))}, {$$s: self});}, {$$s: self})
          } else {
            return nil
          };}, {$$s: self});
        return $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["drop"], function $$28(native_event){var self = $$28.$$s == null ? this : $$28.$$s, event = nil;
    ...
    $def(self, '$infos', function $$infos() {
      var self = this, particle_list = nil, infos = nil;
      ...
      infos = (new Map());
      $send(particle_list, 'each', [], function $$29(particle_found){var $a, self = $$29.$$s == null ? this : $$29.$$s;
    ...
    $def(self, '$dig', function $$dig() {
      ...
      ids = [];
      dig_recursive = $send(self, 'lambda', [], function $$30(atome){var self = $$30.$$s == null ? this : $$30.$$s;

        
        if (atome == null) atome = nil;
        ids['$<<'](atome.$id());
        return $send(atome.$attached(), 'each', [], function $$31(attached_atome){var self = $$31.$$s == null ? this : $$31.$$s;
    ...
    $def(self, '$fit', function $$fit(params) {
      ...
      if ($eqeq(axis, "x")) {
        ...
        return $send(atomes_found, 'each', [], function $$32(atome_id){var self = $$32.$$s == null ? this : $$32.$$s, current_atome = nil, new_width = nil, new_height = nil;
        ...
        return $send(atomes_found, 'each', [], function $$33(atome_id){var self = $$33.$$s == null ? this : $$33.$$s, current_atome = nil;
    ...
    $def(self, '$found_area_used', function $$found_area_used(ids) {
      ...
      $send(ids, 'each', [], function $$34(id){var self = $$34.$$s == null ? this : $$34.$$s, atome = nil, x = nil, y = nil, width = nil, height = nil;
    ...
    $def(self, '$calculate_total_size', function $$calculate_total_size(objet_atome, axis) {
      ...
      $send(objet_atome.$attached(), 'each', [], function $$35(child_id){var self = $$35.$$s == null ? this : $$35.$$s, child = nil, child_size = nil, other_axis_size = nil;
    ...
    $def(self, '$resize_and_reposition', function $$resize_and_reposition(objet_atome, scale_factor, axis, max_other_axis_size) {
      ...
      return $send(objet_atome.$attached(), 'each', [], function $$36(child_id){var self = $$36.$$s == null ? this : $$36.$$s, child = nil;
    ...
    return $def(self, '$atomizer', function $$atomizer(params) {
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('include,[],identity_generator,new,[]=,to_h,map,reject,include?,merge,collapse,particle_main,to_proc,instance_variable_set,particle_pre,particle_callback,store_proc,render,particle_post,particle_after,instance_variables,==,join,inspect,instance_variable_get,class');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$initialize', function $$initialize(new_atome) {
      var atomes_proc = $$initialize.$$p || nil, self = this, $ret_or_1 = nil, ordered_keys = nil, ordered_part = nil, other_part = nil, reordered_atome = nil;
      ...
      self.history = (new Map());
      self.callback = (new Map());
      self.tag = (new Map());
      self.selected = false;
      self.unit = (new Map());
      self.collect = (new Map());
      self.id = ($truthy(($ret_or_1 = new_atome['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("element")));
      ...
      ordered_keys = ["renderers", "id", "alien", "type"];
      ordered_part = $send(ordered_keys, 'map', [], function $$1(k){
        
        if (k == null) k = nil;
        return [k, new_atome['$[]'](k)];}).$to_h();
      other_part = $send(new_atome, 'reject', [], function $$2(k, _){
        
        if (k == null) k = nil;
        if (_ == null) _ = nil;
        return ordered_keys['$include?'](k);});
      reordered_atome = ordered_part.$merge(other_part);
      return self.$collapse(reordered_atome);
    }, -1);
...
Opal.modules["atome/genesis/generators/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?,create_color_hash,[],sub,to_s,[]=,to_sym,==,length,split,instance_variable_set,compute,delete,merge!,each_with_index,send,text,add_user=');
  ...
  $send(self, 'new', [(new Map([["sanitizer", "color"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, uniq_value = nil;
    ...
    if (!$truthy(params['$[]']("id"))) {
      ...
      params['$[]=']("id", ((("" + (self.id)) + "_color_") + (uniq_value)).$to_sym());
    };
  ...
  $send(self, 'new', [(new Map([["sanitizer", "element"]]))], function $$6(params){var default_params = nil;
  ...
  $send(self, 'new', [(new Map([["post", "text"]]))], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s, data_found = nil;

    
    if (params == null) params = nil;
    data_found = params['$[]']("data");
    if ($truthy(data_found['$instance_of?']($$('Array')))) {
      $send(data_found, 'each_with_index', [], function $$8(data_found, index){var self = $$8.$$s == null ? this : $$8.$$s;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["sanitizer", "text"]]))], function $$9(params){
    ...
    return params;});
  $send(self, 'new', [(new Map([["atome", "human"]]))], function $$10(params){var $a;
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,[]=,identity_generator,merge,reject,has_key?,include?,==,grab,length,atomes,new,to_proc,atome_common,preset_common');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$atome_common', function $$atome_common(atome_preset, params) {
      ...
      basic_params['$[]=']("id", ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator(atome_preset))));
      ...
      if ($truthy(["color", "shadow", "paint"]['$include?'](atome_preset))) {
    ...
    $def(self, '$preset_common', function $$preset_common(params) {
      var bloc = $$preset_common.$$p || nil, self = this;

      $$preset_common.$$p = null;
      
      ;
      if ($truthy(self.$grab(params['$[]']("id")))) {
        params['$[]=']("id", "" + (params['$[]']("id")) + "_" + ($$('Universe').$atomes().$length()))
      };
      return $send($$('Atome'), 'new', [params], bloc.$to_proc());
    });
    
    $def(self, '$box', function $$box(params) {
      var bloc = $$box.$$p || nil, self = this, atome_preset = nil;
      ...
      return $send(self, 'preset_common', [params], bloc.$to_proc());
    }, -1);
    return $def(self, '$circle', function $$circle(params) {
      var bloc = $$circle.$$p || nil, self = this, atome_preset = nil;
...
Opal.modules["atome/genesis/generators/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?,connect,html,[],to_proc,[]=,current_user,password,send_message,controller_sender');
  
  $send(self, 'new', [(new Map([["particle", "connection"]]))], function $$1(params, bloc){var self = $$1.$$s == null ? this : $$1.$$s;

    
    if (params == null) params = nil;
    if (bloc == null) bloc = nil;
    if (!$truthy(params['$instance_of?']($$('Hash')))) {
      params = (new Map([["server", params]]))
    };
    return $send(self.$html(), 'connect', [params['$[]']("server")], bloc.$to_proc());}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "message"]]))], function $$2(params, bloc){var self = $$2.$$s == null ? this : $$2.$$s;
    ...
    return $send(self.$html(), 'send_message', [params], bloc.$to_proc());}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "controller"]]))], function $$3(msg){
    
    if (msg == null) msg = nil;
    return $$('Atome').$controller_sender(msg);});
};

Opal.modules["atome/genesis/generators/effect"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?');
  
  self.$new((new Map([["particle", "smooth"]])));
  return $send(self, 'new', [(new Map([["particle", "blur"]]))], function $$1(params){
    
    if (params == null) params = nil;
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      return nil
    } else {
      return (new Map([["value", params], ["affect", "self"]]))
    };});
};

Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?,[]=,[],keys,===,instance_variable_get');
  
  self.$new((new Map([["particle", "touch"], ["type", "hash"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "touch"]]))], function $$1(params, user_bloc){var $a, self = $$1.$$s == null ? this : $$1.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "play"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "play"]]))], function $$2(params, user_bloc){var $a, self = $$2.$$s == null ? this : $$2.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "pause"]])));
  self.$new((new Map([["particle", "time"]])));
  self.$new((new Map([["particle", "on"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "on"]]))], function $$3(params, user_bloc){var $a, self = $$3.$$s == null ? this : $$3.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "fullscreen"]])));
  self.$new((new Map([["particle", "mute"]])));
  self.$new((new Map([["particle", "drag"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "drag"]]))], function $$4(params, user_bloc){var $a, self = $$4.$$s == null ? this : $$4.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "drop"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "drop"]]))], function $$5(params, user_bloc){var $a, self = $$5.$$s == null ? this : $$5.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "over"], ["type", "hash"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "over"]]))], function $$6(params, user_bloc){var $a, self = $$6.$$s == null ? this : $$6.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "targets"]])));
  self.$new((new Map([["particle", "start"]])));
  ...
  self.$new((new Map([["particle", "stop"]])));
  ...
  self.$new((new Map([["particle", "begin"]])));
  self.$new((new Map([["particle", "end"]])));
  self.$new((new Map([["particle", "duration"]])));
  self.$new((new Map([["particle", "mass"]])));
  self.$new((new Map([["particle", "damping"]])));
  self.$new((new Map([["particle", "stiffness"]])));
  self.$new((new Map([["particle", "velocity"]])));
  self.$new((new Map([["particle", "repeat"]])));
  self.$new((new Map([["particle", "ease"]])));
  self.$new((new Map([["particle", "keyboard"], ["type", "hash"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "keyboard"]]))], function $$9(params, user_bloc){var $a, self = $$9.$$s == null ? this : $$9.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "resize"], ["store", false]])));
  $send(self, 'new', [(new Map([["sanitizer", "resize"]]))], function $$10(params, user_bloc){var $a, self = $$10.$$s == null ? this : $$10.$$s, $ret_or_1 = nil, option = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "overflow"]]))], function $$11(params, bloc){var self = $$11.$$s == null ? this : $$11.$$s, $ret_or_1 = nil;
...
Opal.modules["atome/genesis/generators/geometry"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$new((new Map([["particle", "width"]])));
  self.$new((new Map([["particle", "height"]])));
  return $send(self, 'new', [(new Map([["particle", "size"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, $ret_or_1 = nil, original_width = nil, original_height = nil;
...
Opal.modules["atome/genesis/generators/hierarchy"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('attach,grab,delete,attached,==,attached=,include?,push,detach_child,render,to_proc,detach_from_parent,new,attachment_common,instance_of?,each,<<,id,instance_variable_get,instance_variable_set,apply,detach_atome');
  ...
  $def(self, '$detach_from_parent', function $$detach_from_parent(parent_found, child_found) {
    
    return child_found.$attach(false)
  });
  ...
  $def(self, '$attachment_common', function $$attachment_common(child_id, parents_id, direction) {
    ...
    if ($eqeq(direction, "attach")) {
      if ($truthy(parent_found)) {
        ...
        return self.$grab(self.$attach()).$attached().$delete(self.id)
      }
    } else {
      
      child_found = self.$grab(child_id);
      self.$detach_from_parent(parent_found, child_found);
      return $send(child_found, 'render', ["attach", parents_id], user_proc.$to_proc());
    };
  });
  $send(self, 'new', [(new Map([["particle", "attach"], ["render", false]]))], function $$1(parents_id){var user_proc = $$1.$$p || nil, self = $$1.$$s == null ? this : $$1.$$s;
    if (self.id == null) self.id = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "attached"], ["render", false]]))], function $$3(children_ids){var user_proc = $$3.$$p || nil, self = $$3.$$s == null ? this : $$3.$$s, parents_id = nil;
    if (self.id == null) self.id = nil;
  ...
  $send(self, 'new', [(new Map([["sanitizer", "attached"]]))], function $$5(children_ids){
    ...
    if (children_ids == null) children_ids = nil;
    return children_ids;});
  $send(self, 'new', [(new Map([["particle", "apply"], ["render", false], ["store", false]]))], function $$6(parents_ids){var user_proc = $$6.$$p || nil, self = $$6.$$s == null ? this : $$6.$$s, $ret_or_1 = nil, children_ids = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "affect"], ["render", false]]))], function $$10(children_ids){var user_proc = $$10.$$p || nil, self = $$10.$$s == null ? this : $$10.$$s;
    ...
    $send(children_ids, 'each', [], function $$11(child_id){var $a, self = $$11.$$s == null ? this : $$11.$$s, child_found = nil;

      
      if (child_id == null) child_id = nil;
      child_found = self.$grab(child_id);
      return ($a = child_found, ($a === nil || $a == null) ? nil : $send($a, 'apply', [[self.$id()]], user_proc.$to_proc()));}, {$$s: self});
    return children_ids;}, {$$s: self});
  self.$new((new Map([["particle", "detached"], ["store", false]])));
  ...
  return self.$new((new Map([["particle", "collect"]])));
};

Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $neqeq = Opal.neqeq, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,to_sym,!=,update_atome_id,add_to_atomes,instance_of?,each,<<,grab,collect=,==,selection,current_user,delete,collect');
  
  self.$new((new Map([["particle", "real"]])));
  self.$new((new Map([["particle", "type"]])));
  self.$new((new Map([["particle", "id"]])));
  $send(self, 'new', [(new Map([["sanitizer", "id"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s;
    if (self.id == null) self.id = nil;

    
    if (params == null) params = nil;
    params = params.$to_sym();
    if ($neqeq(self.id.$to_sym(), params)) {
      $$('Universe').$update_atome_id(params, self, self.id)
    } else {
      $$('Universe').$add_to_atomes(params, self)
    };
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "name"]])));
  self.$new((new Map([["particle", "active"]])));
  self.$new((new Map([["particle", "markup"]])));
  self.$new((new Map([["particle", "bundle"]])));
  self.$new((new Map([["particle", "data"]])));
  $send(self, 'new', [(new Map([["particle", "category"], ["store", false]]))], function $$2(category_names){var self = $$2.$$s == null ? this : $$2.$$s;
  ...
  self.$new((new Map([["particle", "selection"]])));
  ...
  $send(self, 'new', [(new Map([["particle", "selected"]]))], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s;
    if (self.id == null) self.id = nil;
    ...
    return params;}, {$$s: self});
  self.$new((new Map([["particle", "format"]])));
  return self.$new((new Map([["particle", "alien"]])));
};

Opal.modules["atome/genesis/generators/material"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,each,send,instance_of?,[],color,delete,paint,==,puts,classes,[]=,|,id,gsub');
  
  self.$new((new Map([["particle", "component"]])));
  self.$new((new Map([["particle", "edit"]])));
  self.$new((new Map([["particle", "style"]])));
  ...
  self.$new((new Map([["particle", "hide"]])));
  self.$new((new Map([["particle", "remove"]])));
  $send(self, 'new', [(new Map([["post", "remove"]]))], function $$3(params){var self = $$3.$$s == null ? this : $$3.$$s;
    ...
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      ...
      switch (params['$[]']("all").valueOf()) {
        case "color":
          $send(self.$color(), 'each', [], function $$4(atome_id_found){var self = $$4.$$s == null ? this : $$4.$$s;
            if (self.apply == null) self.apply = nil;
          ...
          break;
        case "paint":
          $send(self.$paint(), 'each', [], function $$5(atome_id_found){var self = $$5.$$s == null ? this : $$5.$$s;
            if (self.apply == null) self.apply = nil;
          ...
          break;
        default:
          $send(params, 'each', [], function $$6(particle, value){var self = $$6.$$s == null ? this : $$6.$$s;
            if (self.category == null) self.category = nil;
            ...
            switch (particle.valueOf()) {
              case "category":
                ...
                break;
              default:
                return self.$puts("write code")
            };}, {$$s: self})
      }
    };
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "classes"]]))], function $$7(value){var $a, self = $$7.$$s == null ? this : $$7.$$s, $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil, $binary_op_recvr_tmp_1 = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "remove_classes"]]))], function $$8(value){var self = $$8.$$s == null ? this : $$8.$$s;

    
    if (value == null) value = nil;
    return $$('Universe').$classes()['$[]'](value).$delete(self.$id());}, {$$s: self});
  self.$new((new Map([["particle", "opacity"]])));
  self.$new((new Map([["particle", "definition"]])));
  $send(self, 'new', [(new Map([["sanitizer", "definition"]]))], function $$9(params){
    
    if (params == null) params = nil;
    params = params.$gsub(/<svg[^>]*>|<\/svg>/, "");
    return params;});
  self.$new((new Map([["particle", "gradient"]])));
  return self.$new((new Map([["particle", "border"]])));
};

Opal.modules["atome/genesis/generators/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $thrower = Opal.thrower, $rb_minus = Opal.rb_minus, $t_$11 = $thrower('return'), self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('match,to_i,[],to_f,new,[]=,data,keys,insert,delete_at,map,delete,nil?,puts,sort_by!,values,-,instance_of?,to_s,is_a?,respond_to?');
  ...
  $send(self, 'new', [(new Map([["particle", "red"]]))], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "green"]]))], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "blue"]]))], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "alpha"]]))], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "diffusion"]]))], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;

    return self}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "clean"]]))], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s, cell = nil, row_nb = nil, column_nb = nil;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "insert"]]))], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s, content = nil, cell = nil, row_nb = nil, column_nb = nil, position_to_insert = nil;
    ...
    return params;}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "remove"]]))], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s, column = nil;
    ...
    if ($truthy(params['$[]']("row"))) {
      ...
      $send(self.$data(), 'map', [], function $$9(hash){
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "sort"]]))], function $$10(params){var self = $$10.$$s == null ? this : $$10.$$s, column = nil, method = nil;
    ...
    if (($truthy(column['$nil?']()) || ($truthy(method['$nil?']())))) {
      ...
      $t_$11.$throw(nil, $$10.$$is_lambda);
    };
    $send(self.data, 'sort_by!', [], function $$12(row){var value = nil;
    ...
    return params;}, {$$s: self, $$ret: $t_$11});
};

Opal.modules["atome/genesis/generators/security"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?,[]=,encode,[],each,password,==,type,set_password,nil?');
  
  self.$new((new Map([["particle", "password"]])));
  $send(self, 'new', [(new Map([["sanitizer", "password"]]))], function $$1(params){var $a, $b, self = $$1.$$s == null ? this : $$1.$$s;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["read", "password"]]))], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s;
    if (self.authorisations == null) self.authorisations = nil;

    
    if (params == null) params = nil;
    if ($truthy(params['$nil?']())) {
      params = $$('Black_matter').$password()
    };
    if (!$truthy(self.authorisations['$[]']("write")['$[]']("atome"))) {
      params['$[]']("read")['$[]=']("atome", $$('Black_matter').$password()['$[]']("read")['$[]']("atome"))
    };
    if (!$truthy(self.authorisations['$[]']("write")['$[]']("atome"))) {
      params['$[]']("write")['$[]=']("atome", $$('Black_matter').$password()['$[]']("write")['$[]']("atome"))
    };
    return params;}, {$$s: self});
};

Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;
  ...
  self.$new((new Map([["particle", "left"], ["type", "integer"]])));
  self.$new((new Map([["particle", "right"], ["type", "integer"]])));
  self.$new((new Map([["particle", "top"], ["type", "integer"]])));
  self.$new((new Map([["particle", "bottom"], ["type", "integer"]])));
  self.$new((new Map([["particle", "rotate"], ["type", "integer"]])));
  self.$new((new Map([["particle", "direction"], ["type", "string"]])));
  self.$new((new Map([["particle", "center"], ["type", "string"]])));
  self.$new((new Map([["particle", "depth"], ["type", "integer"]])));
  self.$new((new Map([["particle", "position"]])));
  self.$new((new Map([["particle", "organise"]])));
  self.$new((new Map([["particle", "spacing"]])));
  $send(self, 'new', [(new Map([["particle", "display"]]))], function $$1(params){
    ...
    return params;});
  $send(self, 'new', [(new Map([["particle", "layout"]]))], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, mode_found = nil, $ret_or_1 = nil, elements_style = nil, atomes_to_organise = nil, container_name = nil, container = nil, container_class = nil, id_found = nil;
    ...
    if ($eqeq(mode_found, "default")) {
      $send(atomes_to_organise, 'each', [], function $$3(atome_id_to_organise){var self = $$3.$$s == null ? this : $$3.$$s, atome_found = nil;
        ...
        if ($truthy(atome_found.$backup())) {
          ...
          return atome_found.$remove_layout();
        } else {
          return nil
        };}, {$$s: self})
    } else {
      ...
      $send(atomes_to_organise, 'each', [], function $$6(atome_id_to_organise){var self = $$6.$$s == null ? this : $$6.$$s, atome_found = nil;

        
        if (atome_id_to_organise == null) atome_id_to_organise = nil;
        atome_found = self.$grab(atome_id_to_organise);
        if ($truthy(atome_found.$backup())) {
          $send(atome_found.$backup(), 'each', [], function $$7(particle, value){
    ...
    return params;}, {$$s: self});
  return self.$new((new Map([["particle", "center"]])));
};

Opal.modules["atome/genesis/generators/time"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('new');
  return self.$new((new Map([["particle", "markers"], ["type", "hash"]])))
};

Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, $hash_rehash = Opal.hash_rehash, $rb_minus = Opal.rb_minus, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,is_a?,instance_exec,to_proc,[],tag,grab,attach,dup,attached,delete,instance_variable_set,each,delete_recursive,render,touch,==,to_sym,instance_of?,[]=,atome,include?,atome_list,puts,apply,send,<<,to_s,split,union,renderer_list,new_default_params,default_params,set_current_user,id,length,instance_variables,sub,set,duplicate,height,width,keys,-,collect,last,to_i,each_with_index,data');
  
  self.$new((new Map([["particle", "renderers"]])));
  self.$new((new Map([["particle", "code"]])));
  $send(self, 'new', [(new Map([["particle", "run"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, code_found = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "delete"], ["render", false]]))], function $$3(params){var self = $$3.$$s == null ? this : $$3.$$s, id_found = nil, parent_found = nil;
  ...
  self.$new((new Map([["particle", "clear"]])));
  ...
  self.$new((new Map([["particle", "path"]])));
  $send(self, 'new', [(new Map([["particle", "schedule"]]))], function $$9(date, proc){var self = $$9.$$s == null ? this : $$9.$$s, delimiters = nil, format_date = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "read"]]))], function $$11(file, proc){var self = $$11.$$s == null ? this : $$11.$$s;

    
    if (file == null) file = nil;
    if (proc == null) proc = nil;
    return $send($$('Universe').$renderer_list(), 'each', [], function $$12(renderer){var self = $$12.$$s == null ? this : $$12.$$s;

      
      if (renderer == null) renderer = nil;
      return $send(self, 'send', ["" + (renderer) + "_reader", file], proc.$to_proc());}, {$$s: self});}, {$$s: self});
  self.$new((new Map([["particle", "cursor"]])));
  $send(self, 'new', [(new Map([["particle", "preset"]]))], function $$13(params){var self = $$13.$$s == null ? this : $$13.$$s, params_to_send = nil;
    ...
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      ...
      $send(params_to_send, 'each', [], function $$14(particle_found, value){var self = $$14.$$s == null ? this : $$14.$$s;
  ...
  self.$new((new Map([["particle", "relations"], ["type", "hash"]])));
  self.$new((new Map([["particle", "tag"], ["render", false], ["type", "hash"]])));
  self.$new((new Map([["particle", "web"]])));
  self.$new((new Map([["particle", "unit"], ["type", "hash"]])));
  self.$new((new Map([["initialize", "unit"], ["value", (new Map())]])));
  $send(self, 'new', [(new Map([["particle", "login"]]))], function $$15(params){var self = $$15.$$s == null ? this : $$15.$$s;
  ...
  self.$new((new Map([["particle", "hypertext"]])));
  self.$new((new Map([["particle", "hyperedit"]])));
  self.$new((new Map([["particle", "terminal"]])));
  self.$new((new Map([["particle", "read"]])));
  self.$new((new Map([["particle", "browse"]])));
  self.$new((new Map([["particle", "copies"]])));
  self.$new((new Map([["particle", "temporary"]])));
  self.$new((new Map([["particle", "atomes"]])));
  $send(self, 'new', [(new Map([["particle", "match"]]))], function $$16(params, _bloc){
  ...
  $send(self, 'new', [(new Map([["sanitizer", "match"]]))], function $$17(params, _bloc){
    ...
    return params;});
  self.$new((new Map([["particle", "invert"]])));
  self.$new((new Map([["particle", "option"]])));
  $send(self, 'new', [(new Map([["particle", "duplicate"], ["store", false]]))], function $$18(params){var self = $$18.$$s == null ? this : $$18.$$s, copy_number = nil, new_atome_id = nil, new_atome = nil, attached_atomes = nil, attached_found = nil, particles_found = nil, keys_to_delete = nil, $ret_or_1 = nil;
    if (self.duplicate == null) self.duplicate = nil;
    if (self.id == null) self.id = nil;
    if (self.type == null) self.type = nil;
    if (self.renderers == null) self.renderers = nil;
    ...
    new_atome_id = "" + (self.id) + "_copy_" + (copy_number);
    new_atome = $$('Atome').$new((new Map([["type", self.type], ["renderers", self.renderers], ["id", new_atome_id]])));
    attached_atomes = [];
    attached_found = self.$attached().$dup();
    particles_found = self.$instance_variables().$dup();
    keys_to_delete = ["@history", "@callback", "@duplicate", "@copy", "@paste", "@touch_code", "@html", "@attached", "@id"];
    $send(keys_to_delete, 'each', [], function $$19(key){
      
      if (key == null) key = nil;
      return particles_found.$delete(key);});
    params['$[]=']("id", new_atome_id);
    $send(particles_found, 'each', [], function $$20(particle_found){var self = $$20.$$s == null ? this : $$20.$$s, particle_name = nil, particle_content = nil;

      
      if (particle_found == null) particle_found = nil;
      particle_name = particle_found.$to_s().$sub("@", "");
      particle_content = self.$send(particle_name);
      if ($eqeq(particle_content, false)) {
        particle_content = "view"
      };
      return new_atome.$set($hash_rehash(new Map([[particle_name, particle_content]])));}, {$$s: self});
    $send(attached_found, 'each', [], function $$21(child_id_found){var self = $$21.$$s == null ? this : $$21.$$s, child_found = nil, new_child = nil;
    ...
    new_atome.$height(self.height);
    new_atome.$width(self.width);
    if ($truthy(params['$instance_of?']($$('Hash')))) {
      $send(params, 'each', [], function $$22(k, v){
        
        if (k == null) k = nil;
        if (v == null) v = nil;
        return new_atome.$send(k, v);})
    };
  ...
  $send(self, 'new', [(new Map([["after", "duplicate"]]))], function $$23(params){var self = $$23.$$s == null ? this : $$23.$$s;
    if (self.duplicate == null) self.duplicate = nil;

    
    if (params == null) params = nil;
    return self.duplicate['$[]'](self.duplicate.$keys()['$[]']($rb_minus(self.duplicate.$keys().$length(), 1)));}, {$$s: self});
  $send(self, 'new', [(new Map([["particle", "copy"]]))], function $$24(items_id){var self = $$24.$$s == null ? this : $$24.$$s;
  ...
  $send(self, 'new', [(new Map([["particle", "paste"]]))], function $$25(params){var self = $$25.$$s == null ? this : $$25.$$s, all_copies = nil, copies_found = nil, new_atomes = nil, applies_found = nil;
    ...
    new_atomes = [];
    applies_found = [];
    $send(copies_found, 'each', [], function $$26(copy_found){var self = $$26.$$s == null ? this : $$26.$$s, new_atome = nil;
      if (self.id == null) self.id = nil;
    ...
    $send(new_atomes, 'each_with_index', [], function $$27(id_found, index){var self = $$27.$$s == null ? this : $$27.$$s;
  ...
  $send(self, 'new', [(new Map([["read", "paste"]]))], function $$28(p){var self = $$28.$$s == null ? this : $$28.$$s;
    if (self.copy == null) self.copy = nil;

    
    if (p == null) p = nil;
    return self.copy;}, {$$s: self});
  self.$new((new Map([["particle", "backup"]])));
  self.$new((new Map([["particle", "import"]])));
  $send(self, 'new', [(new Map([["particle", "compute"]]))], function $$29(params){var $ret_or_1 = nil;
    ...
    return params;});
  return $send(self, 'new', [(new Map([["particle", "get"]]))], function $$30(params){var self = $$30.$$s == null ? this : $$30.$$s, cell = nil, row_nb = nil, column_nb = nil;
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $eqeq = Opal.eqeq, $gvars = Opal.gvars, $thrower = Opal.thrower, $defs = Opal.defs, $truthy = Opal.truthy, $not = Opal.not, $range = Opal.range, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('require,instance_exec,grab,to_proc,==,to_json,inspect,eval,send,atome_js,each,is_a?,instance_variable_get,!,instance_of?,get_sanitizer_method,particle_sanitizer,atome_common,atome_pre_process,atome_post_process,[]=,story,instance_variable_set,attr_accessor,[],values,define_method,call,keys,atome,each_with_object,instance_variables,to_sym,include?,delete,to_s,to_hash,collect,<<,puts,users,current_user=,debug,display,attach,remove,category,length,attached');
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    (function(self, $parent_nesting) {
      ...
      return $def(self, '$controller_sender', function $$controller_sender(message) {try { 
    ...
    $def(self, '$collapse', function $$collapse(new_atome) {
      ...
      return $send(new_atome, 'each', [], function $$1(element, value){var self = $$1.$$s == null ? this : $$1.$$s;
    ...
    $def(self, '$store', function $$store(params) {
      
      return $send(params, 'each', [], function $$2(particle_to_save, data){
        
        if (particle_to_save == null) particle_to_save = nil;
        if (data == null) data = nil;
        return nil;})
    });
    
    $def(self, '$history', function $$history(filter) {
      var self = this;

      
      if (filter == null) filter = (new Map());
      filter['$[]=']("id", self.id);
      return $$('Universe').$story(filter);
    }, -1);
    
    $def(self, '$store_proc', function $$store_proc(element, params) {
      var user_proc = $$store_proc.$$p || nil, $a, self = this, elem_code = nil, option_found = nil;
      ...
      if ($truthy(params['$instance_of?']($$('Hash')))) {
        ...
        return ($a = ["" + (option_found) + "_code", user_proc], $send(self.$instance_variable_get(elem_code), '[]=', $a), $a[$a.length - 1]);
      } else {
    ...
    $def(self, '$particle_callback', function $$particle_callback(element) {
      ...
      return $send($$('Atome'), 'define_method', ["" + (element) + "_callback"], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s, proc_found = nil;
        if (self.callback == null) self.callback = nil;

        
        proc_found = self.$instance_variable_get("@" + (element) + "_code")['$[]'](element);
        if ($truthy(proc_found['$is_a?']($$('Proc')))) {
          return proc_found.$call(self.callback['$[]'](element))
        } else {
          return nil
        };}, {$$s: self})
    });
    
    $def(self, '$call', function $$call(element) {
      var self = this;

      return self.$send("" + (element) + "_callback")
    });
    
    $def(self, '$callback', function $$callback(data) {
      var $a, self = this;

      return ($a = [data.$keys()['$[]'](0), data['$[]'](data.$keys()['$[]'](0))], $send(self.callback, '[]=', $a), $a[$a.length - 1])
    });
    ...
    $def(self, '$atome', function $$atome() {
      ...
      return $send(self.$instance_variables(), 'each_with_object', [(new Map())], function $$5(var$, hash){var $a, self = $$5.$$s == null ? this : $$5.$$s;
    ...
    $def(self, '$to_hash', function $$to_hash() {
      ...
      hash = (new Map());
      $send(self.$instance_variables(), 'each', [], function $$6(var$){var $a, self = $$6.$$s == null ? this : $$6.$$s;

        
        if (var$ == null) var$ = nil;
        if ($truthy(["@html_object", "@history"]['$include?'](var$))) {
          return nil
        };
    ...
    $def(self, '$refresh', function $$refresh() {
      ...
      particles_found = self.$to_hash();
      return $send(particles_found, 'each', [], function $$7(particle_found, value_found){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    $def(self, '$each', function $$each() {
      ...
      ;
      return $send(self.$collect(), 'each', [], function $$8(val){var self = $$8.$$s == null ? this : $$8.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$9(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$10(value) {
      var self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$11(particle, value){var self = $$11.$$s == null ? this : $$11.$$s;
    ...
    return $def(self, '$remove_layout', function $$remove_layout() {
...
Opal.modules["atome/helpers/security"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["renderers/html/communication"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.8.2 */
...
Opal.modules["renderers/html/effect"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,===,each,<<,join,end_with?,is_a?,style,html,==,[],backdropFilter,filter');
  ...
  return $send(self, 'new', [(new Map([["renderer", "html"], ["method", "blur"], ["type", "integer"]]))], function $$3(params, _user_proc){var self = $$3.$$s == null ? this : $$3.$$s;
...
Opal.modules["renderers/html/geometry"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,[],unit,style,html,is_a?');
  
  $send(self, 'new', [(new Map([["method", "width"], ["type", "integer"], ["renderer", "html"]]))], function $$1(value, _user_proc){var self = $$1.$$s == null ? this : $$1.$$s, unit_found = nil;

    
    if (value == null) value = nil;
    if (_user_proc == null) _user_proc = nil;
    unit_found = self.$unit()['$[]']("width");
    if ($truthy(unit_found)) {
      return self.$html().$style("width", "" + (value) + (unit_found))
    } else if ($truthy(value['$is_a?']($$('Numeric')))) {
      return self.$html().$style("width", "" + (value) + "px")
    } else {
      return self.$html().$style("width", value)
    };}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "height"], ["renderer", "html"], ["type", "string"]]))], function $$2(value, _user_proc){var self = $$2.$$s == null ? this : $$2.$$s, unit_found = nil;

    
    if (value == null) value = nil;
    if (_user_proc == null) _user_proc = nil;
    unit_found = self.$unit()['$[]']("height");
    if ($truthy(unit_found)) {
      return self.$html().$style("height", "" + (value) + (unit_found))
    } else if ($truthy(value['$is_a?']($$('Numeric')))) {
      return self.$html().$style("height", "" + (value) + "px")
    } else {
      return self.$html().$style("height", value)
    };}, {$$s: self});
...
Opal.modules["renderers/html/hierarchy"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,append_to,html,type,each,shadow,grab,*,red,green,blue,alpha,left,top,[],blur,invert,==,option,<<,join,style,paint,diffusion,direction,params,rotate,gradient,last,colorize_svg_data');
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"]]))], function $$2(parent_found, _user_proc){var self = $$2.$$s == null ? this : $$2.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      ...
      case "paint":
        ...
        gradients_to_apply = [];
        $send(self.$paint(), 'each', [], function $$4(paint_id){var self = $$4.$$s == null ? this : $$4.$$s, colors_to_apply = nil, paint_atome = nil, paint_diffusion = nil, paint_direction = nil, diffusion = nil, $ret_or_2 = nil, direction = nil;
          ...
          $send(paint_atome.$gradient(), 'each', [], function $$5(color_id){var self = $$5.$$s == null ? this : $$5.$$s, color_found = nil;
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"], ["specific", "text"]]))], function $$6(parent_found, _user_proc){var self = $$6.$$s == null ? this : $$6.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      case "shadow":
        ...
        shadows_to_apply = (new Map([["filter", []], ["boxShadow", []]]));
        $send(self.$shadow(), 'each', [], function $$7(shadow_id_found){var self = $$7.$$s == null ? this : $$7.$$s, shadow_found = nil, red = nil, green = nil, blue = nil, alpha = nil, left = nil, top = nil, blur = nil, inset = nil;
      ...
      case "paint":
        ...
        gradients_to_apply = [];
        $send(self.$paint(), 'each', [], function $$8(paint_id){var self = $$8.$$s == null ? this : $$8.$$s, colors_to_apply = nil, paint_atome = nil, paint_diffusion = nil, paint_direction = nil, diffusion = nil, $ret_or_2 = nil, direction = nil;
          ...
          $send(paint_atome.$gradient(), 'each', [], function $$9(color_id){var self = $$9.$$s == null ? this : $$9.$$s, color_found = nil;
  ...
  return $send(self, 'new', [(new Map([["renderer", "html"], ["method", "apply"], ["type", "string"], ["specific", "vector"]]))], function $$10(parent_found, _user_proc){var self = $$10.$$s == null ? this : $$10.$$s, shadows_to_apply = nil, drop_shadow = nil, box_shadow = nil, red = nil, green = nil, blue = nil, alpha = nil, gradients_to_apply = nil, full_gradient_to_apply = nil;
    ...
    switch (parent_found.$type().valueOf()) {
      case "shadow":
        ...
        shadows_to_apply = (new Map([["filter", []], ["boxShadow", []]]));
        $send(self.$shadow(), 'each', [], function $$11(shadow_id_found){var self = $$11.$$s == null ? this : $$11.$$s, shadow_found = nil, red = nil, green = nil, blue = nil, alpha = nil, left = nil, top = nil, blur = nil, inset = nil;
      ...
      case "paint":
        ...
        gradients_to_apply = [];
        $send(self.$paint(), 'each', [], function $$12(paint_id){var self = $$12.$$s == null ? this : $$12.$$s, colors_to_apply = nil, paint_atome = nil, paint_diffusion = nil, paint_direction = nil, diffusion = nil, $ret_or_2 = nil, direction = nil;
          ...
          $send(paint_atome.$gradient(), 'each', [], function $$13(color_id){var self = $$13.$$s == null ? this : $$13.$$s, color_found = nil;
...
Opal.modules["renderers/html/html"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $defs = Opal.defs, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $to_ary = Opal.to_ary, $range = Opal.range, $thrower = Opal.thrower, $rb_times = Opal.rb_times, $lambda = Opal.lambda, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $rb_lt = Opal.rb_lt, $rb_ge = Opal.rb_ge, $rb_le = Opal.rb_le, $rb_divide = Opal.rb_divide, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],global,empty?,has_key?,querySelector,nil?,to_a,querySelectorAll,getElementById,to_s,[]=,createTextNode,appendChild,<<,==,each,is_a?,join,add_css_to_atomic_style,map,split,match,to_proc,to_sym,to_i,scan,reject,with_index,select,odd?,strip,start_with?,end_with?,extract_properties,get_page_style,merge,chomp,grab,callback,call,convert_to_css,css_to_data,eval,close,setAttribute,add,remove,attr,inspect,delete,check_double,markup,createElement,add_class,id,*,red,green,blue,alpha,createRange,selectNodeContents,getSelection,removeAllRanges,addRange,focus,length,createElementNS,gsub,sanitize_text,lambda,requestAnimationFrame,to_f,instance_exec,animation_frame_callback,currentTime,pause,instance_variable_get,play,last,matchMedia,addListener,addEventListener,Native,send,left,top,on,draggable,+,instance_of?,to_px,width,height,-,min,max,restrict_movement,dropzone,drop_action,resizable,between?,style,over_code,new,removeEventListener,host,puts,instance_variable_set,handle_input,keys,raise,animate,max_by,option,times,first,compact,each_with_index,set_td_style,values,fit,data,attach,downto,deleteRow,insertRow,insertCell,innerHTML=,zero?,insertBefore,firstChild,<,insert_cell,insert_row,insert_column,>=,removeChild,<=,apply_centering,private,calculate_position,/,chop');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'HTML');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.element = $proto.id = $proto.websocket = $proto.original_atome = $proto.element_type = $proto.over_enter = $proto.over_enter_callback = $proto.over_leave = $proto.over_leave_callback = $proto.input_listener = $proto.center_options = $proto.parent = nil;
    ...
    $def(self, '$css_to_data', function $$css_to_data(css) {
      ...
      $send(media_conditions, 'each', [], function $$3(condition){var $a, type = nil, property = nil, value = nil, $logical_op_recvr_tmp_2 = nil, $ret_or_1 = nil;
        ...
        $logical_op_recvr_tmp_2 = data['$[]']("condition");
        if ($truthy(($ret_or_1 = $logical_op_recvr_tmp_2['$[]'](type)))) {
          $ret_or_1
        } else {
          $logical_op_recvr_tmp_2['$[]='](type, (new Map()))
        };;
        return ($a = [property, value], $send(data['$[]']("condition")['$[]'](type), '[]=', $a), $a[$a.length - 1]);});
      $send(css.$scan(/(\w+) \{([^\}]+)\}/), 'each', [], function $$4(match){var key = nil, properties = nil, $logical_op_recvr_tmp_3 = nil, $ret_or_1 = nil;
        ...
        $logical_op_recvr_tmp_3 = data['$[]']("apply");
        if ($truthy(($ret_or_1 = $logical_op_recvr_tmp_3['$[]'](key)))) {
          $ret_or_1
        } else {
          $logical_op_recvr_tmp_3['$[]='](key, (new Map()))
        };;
    ...
    $def(self, '$hyperedit', function $$hyperedit(params) {
      ...
      current_atome.$callback((new Map([["hyperedit", particles_found]])));
      return current_atome.$call("hyperedit");
    });
    ...
    $def(self, '$connect', function $$connect(params) {try { 
      var bloc = $$connect.$$p || nil;

      $$connect.$$p = null;
      
      ;
      return $$('JS').$eval("atomeJS.connect('ws://" + (params) + "')");} catch($e) {
        if ($e === Opal.t_eval_return) return $e.$v;
        throw $e;
      }
    });
    ...
    $def(self, '$svg_data', function $$svg_data(data) {
      var self = this;

      return $send(data, 'each', [], function $$11(type_passed, datas){var self = $$11.$$s == null ? this : $$11.$$s, svg_ns = nil, new_path = nil;
        ...
        $send(datas, 'each', [], function $$12(property, value){
          
          if (property == null) property = nil;
          if (value == null) value = nil;
          return new_path.$setAttribute(property.$to_s(), value.$to_s());});
        return self.element.$appendChild(new_path);}, {$$s: self})
    });
    
    $def(self, '$update_svg_data', function $$update_svg_data(data) {
      
      return $send(data, 'each', [], function $$13(type_passed, datas){var element_to_update = nil;

        
        if (type_passed == null) type_passed = nil;
        if (datas == null) datas = nil;
        element_to_update = $$('JS').$global()['$[]']("document").$getElementById(type_passed.$to_s());
        return $send(datas, 'each', [], function $$14(property, value){
    ...
    $def(self, '$path', function $$path(objet_path) {
      ...
      return ($a = ["onload", $send(self, 'lambda', [], function $$15(_event){var self = $$15.$$s == null ? this : $$15.$$s;
        if (self.element == null) self.element = nil;
    ...
    $def(self, '$animation_frame_callback', function $$animation_frame_callback(proc_pass, play_content) {
      ...
      return $$('JS').$global()['$[]']("window").$requestAnimationFrame($lambda(function $$16(timestamp){var self = $$16.$$s == null ? this : $$16.$$s, current_time = nil, fps = nil, current_frame = nil;
        if (self.element == null) self.element = nil;
    ...
    $def(self, '$delete', function $HTML_delete$17(id_to_delete) {
    ...
    $def(self, '$on', function $$on(property, _option) {
      ...
      if ($truthy(property['$start_with?']("media:"))) {
        ...
        event_handler = $lambda(function $$18(event){
        ...
        event_handler = $lambda(function $$19(event){var width = nil, height = nil;
        ...
        event_handler = $lambda(function $$20(event){
    ...
    $def(self, '$keyboard_press', function $$keyboard_press(_option) {
      ...
      keypress_handler = $lambda(function $$21(native_event){var self = $$21.$$s == null ? this : $$21.$$s, event = nil;
    ...
    $def(self, '$keyboard_down', function $$keyboard_down(_option) {
      ...
      keypress_handler = $lambda(function $$22(event){var self = $$22.$$s == null ? this : $$22.$$s;
    ...
    $def(self, '$keyboard_up', function $$keyboard_up(_option) {
      ...
      keypress_handler = $lambda(function $$23(event){var self = $$23.$$s == null ? this : $$23.$$s;
    ...
    $def(self, '$drag_remove', function $$drag_remove(option) {
      var self = this;
    ...
    $def(self, '$drag_start', function $$drag_start(_option) {try { 
      ...
      return $send(interact, 'on', ["dragstart"], function $$24(native_event){var self = $$24.$$s == null ? this : $$24.$$s, event = nil;
    ...
    $def(self, '$drag_end', function $$drag_end(_option) {try { 
      ...
      return $send(interact, 'on', ["dragend"], function $$25(native_event){var self = $$25.$$s == null ? this : $$25.$$s, event = nil;
    ...
    $def(self, '$drag_move', function $$drag_move(_option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$26(native_event){var self = $$26.$$s == null ? this : $$26.$$s, event = nil, dx = nil, dy = nil, x = nil, $ret_or_1 = nil, y = nil;
    ...
    $def(self, '$drag_restrict', function $$drag_restrict(option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$27(native_event){var self = $$27.$$s == null ? this : $$27.$$s, event = nil, dx = nil, dy = nil, x = nil, y = nil, restricted_x = nil, restricted_y = nil;
        if (self.drag_move == null) self.drag_move = nil;
        if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$drag_locked', function $$drag_locked(_option) {try { 
      ...
      return $send(interact, 'on', ["dragmove"], function $$28(native_event){var self = $$28.$$s == null ? this : $$28.$$s, event = nil;
    ...
    $def(self, '$drop_activate', function $$drop_activate(_option) {try { 
      ...
      return interact.$dropzone((new Map([["accept", nil], ["overlap", 0.75], ["ondropactivate", $send(self, 'lambda', [], function $$29(native_event){var self = $$29.$$s == null ? this : $$29.$$s;
    ...
    $def(self, '$drop_deactivate', function $$drop_deactivate(_option) {try { 
      ...
      return interact.$dropzone((new Map([["ondropdeactivate", $send(self, 'lambda', [], function $$30(native_event){var self = $$30.$$s == null ? this : $$30.$$s;
    ...
    $def(self, '$drop_dropped', function $$drop_dropped(_option) {try { 
      ...
      interact = $$('JS').$eval("return interact('#" + (self.id) + "')");
      return interact.$dropzone((new Map([["overlap", 0.75], ["ondrop", $send(self, 'lambda', [], function $$31(native_event){var self = $$31.$$s == null ? this : $$31.$$s;
    ...
    $def(self, '$drop_enter', function $$drop_enter(_option) {try { 
      ...
      return interact.$dropzone((new Map([["overlap", 0.001], ["ondragenter", $send(self, 'lambda', [], function $$32(native_event){var self = $$32.$$s == null ? this : $$32.$$s;
    ...
    $def(self, '$drop_leave', function $$drop_leave(_option) {try { 
      ...
      return interact.$dropzone((new Map([["ondragleave", $send(self, 'lambda', [], function $$33(native_event){var self = $$33.$$s == null ? this : $$33.$$s;
    ...
    $def(self, '$resize', function $$resize(params, options) {try { 
      ...
      if ($eqeq(params, "remove")) {
        ...
        return interact.$resizable((new Map([["edges", (new Map([["left", true], ["right", true], ["top", true], ["bottom", true]]))], ["inertia", true], ["modifiers", []], ["listeners", (new Map([["move", $send(self, 'lambda', [], function $$34(native_event){var self = $$34.$$s == null ? this : $$34.$$s, event = nil, x = nil, y = nil, width = nil, height = nil;
          if (self.resize == null) self.resize = nil;
          if (self.element == null) self.element = nil;
          if (self.original_atome == null) self.original_atome = nil;
          ...
          if ($truthy(self.resize['$is_a?']($$('Proc')))) {
            ...
            self.original_atome.$left(x);
            return self.original_atome.$top(y);
          } else {
            return nil
          };}, {$$s: self})]]))]])));
      };} catch($e) {
    ...
    $def(self, '$overflow', function $$overflow(params, bloc) {
      ...
      return self.element.$addEventListener("scroll", $send(self, 'lambda', [], function $$35(event){var self = $$35.$$s == null ? this : $$35.$$s, scroll_top = nil, scroll_left = nil;
        if (self.element == null) self.element = nil;
    ...
    $def(self, '$over_over', function $$over_over(_option) {try { 
      ...
      return $send(interact, 'on', ["mouseover"], function $$36(native_event){var self = $$36.$$s == null ? this : $$36.$$s, event = nil;
        if (self.id == null) self.id = nil;
        if (self.over_over == null) self.over_over = nil;

        
        if (native_event == null) native_event = nil;
        $$('JS').$global()['$[]=']("myRubyMouseOverCallback", $send($$('Proc'), 'new', [], function $$37(){var self = $$37.$$s == null ? this : $$37.$$s;
          if (self.original_atome == null) self.original_atome = nil;
    ...
    $def(self, '$over_enter', function $$over_enter(_option) {
      ...
      self.over_enter_callback = $send(self, 'lambda', [], function $$38(event){var self = $$38.$$s == null ? this : $$38.$$s;
    ...
    $def(self, '$over_leave', function $$over_leave(_option) {
      ...
      self.over_leave_callback = $send(self, 'lambda', [], function $$39(event){var self = $$39.$$s == null ? this : $$39.$$s;
    ...
    $def(self, '$touch_tap', function $$touch_tap(_option) {try { 
      ...
      return $send(interact, 'on', ["tap"], function $$40(native_event){var self = $$40.$$s == null ? this : $$40.$$s, event = nil;
        if (self.touch_tap == null) self.touch_tap = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        if ($truthy(self.touch_tap['$is_a?']($$('Proc')))) {
    ...
    $def(self, '$touch_double', function $$touch_double(_option) {try { 
      ...
      return $send(interact, 'on', ["doubletap"], function $$41(native_event){var self = $$41.$$s == null ? this : $$41.$$s, event = nil;
        if (self.touch_double == null) self.touch_double = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        if ($truthy(self.touch_double['$is_a?']($$('Proc')))) {
    ...
    $def(self, '$touch_long', function $$touch_long(_option) {try { 
      ...
      interact = $$('JS').$eval("return interact('#" + (self.id) + "')");
      return $send(interact, 'on', ["hold"], function $$42(native_event){var self = $$42.$$s == null ? this : $$42.$$s, event = nil;
        if (self.touch_long == null) self.touch_long = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        if ($truthy(self.touch_long['$is_a?']($$('Proc')))) {
    ...
    $def(self, '$touch_down', function $$touch_down(_option) {try { 
      ...
      return $send(interact, 'on', ["down"], function $$43(native_event){var self = $$43.$$s == null ? this : $$43.$$s, event = nil;
        ...
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        if ($truthy(self.touch_down['$is_a?']($$('Proc')))) {
    ...
    $def(self, '$touch_up', function $$touch_up(_option) {try { 
      ...
      interact = $$('JS').$eval("return interact('#" + (self.id) + "')");
      return $send(interact, 'on', ["up"], function $$44(native_event){var self = $$44.$$s == null ? this : $$44.$$s, event = nil;
        if (self.touch_up == null) self.touch_up = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        if ($truthy(self.touch_up['$is_a?']($$('Proc')))) {
    ...
    $def(self, '$touch_remove', function $$touch_remove(option) {
      var self = this;

      
      switch (option.valueOf()) {
        case "double":
          return (self.touch_double = "")
        case "down":
    ...
    $def(self, '$update_data', function $$update_data(params) {
      ...
      self.input_listener = ($truthy(($ret_or_1 = self.input_listener)) ? ($ret_or_1) : ($send(self, 'lambda', [], function $$45(event){var self = $$45.$$s == null ? this : $$45.$$s;
    ...
    $def(self, '$table', function $$table(data) {
      ...
      max_length = $send(data, 'max_by', [], function $$46(row){
      ...
      if ($truthy(self.original_atome.$option()['$[]']("header"))) {
        ...
        $send(max_length, 'times', [], function $$47(i){var th = nil, $ret_or_1 = nil;

          
          if (i == null) i = nil;
          th = $$('JS').$global()['$[]']("document").$createElement("th");
          th['$[]=']("textContent", ($truthy(($ret_or_1 = $send(data, 'map', [], function $$48(row){
      ...
      $send(data, 'each_with_index', [], function $$49(row, row_index){var self = $$49.$$s == null ? this : $$49.$$s, tr = nil;

        
        if (row == null) row = nil;
        if (row_index == null) row_index = nil;
        tr = $$('JS').$global()['$[]']("document").$createElement("tr");
        $send(max_length, 'times', [], function $$50(cell_index){var self = $$50.$$s == null ? this : $$50.$$s, td = nil, cell_size = nil, cell_height = nil, cell_value = nil, html_element = nil;
    ...
    $def(self, '$refresh_table', function $$refresh_table(_params) {
      ...
      $send(data, 'each', [], function $$51(row){
        
        if (row == null) row = nil;
        return $send(row, 'each', [], function $$52(k, v){
      ...
      $send($rb_minus(table_element['$[]']("rows").$to_a().$length(), 1), 'downto', [1], function $$53(i){
        
        if (i == null) i = nil;
        return table_element.$deleteRow(i);});
      max_cells = $send(data, 'map', [], function $$54(row){
        
        if (row == null) row = nil;
        return row.$keys().$length();}).$max();
      return $send(data, 'each', [], function $$55(row){var self = $$55.$$s == null ? this : $$55.$$s, new_row = nil;

        
        if (row == null) row = nil;
        new_row = table_element.$insertRow(-1);
        return $send(max_cells, 'times', [], function $$56(i){var self = $$56.$$s == null ? this : $$56.$$s, key = nil, value = nil, cell = nil, html_element = nil;
    ...
    $def(self, '$insert_row', function $$insert_row(params) {
      ...
      $send(column_count, 'times', [], function $$57(cell_index){var self = $$57.$$s == null ? this : $$57.$$s, td = nil;
    ...
    $def(self, '$insert_column', function $$insert_column(params) {
      ...
      return $send(rows, 'each_with_index', [], function $$58(row, index){var self = $$58.$$s == null ? this : $$58.$$s, new_cell = nil, child_nodes = nil, reference_cell = nil;
    ...
    $def(self, '$table_remove', function $$table_remove(params) {
      var self = this, row_index = nil, table_element = nil, rows = nil, row_to_remove = nil, column_index = nil;
      ...
      if ($truthy(params['$[]']("row"))) {
        ...
        return $send(rows, 'each_with_index', [], function $$59(row, i){
        ...
        rows = table_element.$querySelectorAll("tbody tr").$to_a();
        return $send(rows, 'each', [], function $$60(row){var cells = nil, cell_to_remove = nil;
    ...
    $def(self, '$center', function $$center(options, attach) {
      ...
      if ($truthy(self.center_options['$[]']("dynamic"))) {
        ...
        event_handler = $lambda(function $$61(event){var self = $$61.$$s == null ? this : $$61.$$s;
...
Opal.modules["renderers/html/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $return_val = Opal.return_val, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('new,shape,html,svg,image,video,www,raw,text,add_class,innerText,svg_data,each,send,update_svg_data,path,raw_data,table,atomized,alien');
  ...
  $send(self, 'new', [(new Map([["method", "data"], ["type", "string"], ["specific", "text"], ["renderer", "html"]]))], function $$9(value, _user_proc){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (value == null) value = nil;
    if (_user_proc == null) _user_proc = nil;
    return self.$html().$innerText(value);}, {$$s: self});
  ...
  return $send(self, 'new', [(new Map([["method", "type"], ["type", "hash"], ["specific", "atomized"], ["renderer", "html"]]))], function $$21(value, _user_proc){var self = $$21.$$s == null ? this : $$21.$$s;
...
Opal.modules["renderers/html/material"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $rb_times = Opal.rb_times, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,overflow,html,instance_of?,each,remove_class,send,[],remove,grab,type,==,color,style,delete,apply,gradient,*,red,green,blue,alpha');
  ...
  return $send(self, 'new', [(new Map([["method", "border"], ["type", "hash"], ["renderer", "html"]]))], function $$6(value, _user_proc){var self = $$6.$$s == null ? this : $$6.$$s, thickness = nil, $ret_or_1 = nil, type = nil, color = nil, color_found = nil;

    
    if (value == null) value = nil;
    if (_user_proc == null) _user_proc = nil;
    thickness = ($truthy(($ret_or_1 = value['$[]']("thickness"))) ? ($ret_or_1) : (5));
    type = ($truthy(($ret_or_1 = value['$[]']("pattern"))) ? ($ret_or_1) : ("solid"));
    color = ($truthy(value['$[]']("color")) ? (((color_found = value['$[]']("color")), "" + ($rb_times(color_found.$red(), 255)) + "," + ($rb_times(color_found.$green(), 255)) + "," + ($rb_times(color_found.$blue(), 255)) + "," + (color_found.$alpha()) + " ")) : ("0,0,0,1"));
    return self.$html().$style("border", "" + (type) + " " + (thickness) + "px rgba(" + (color) + ")");}, {$$s: self});
};

Opal.modules["renderers/html/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $rb_times = Opal.rb_times, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('new,attr,html,update_data,[],*,red,green,blue,alpha,style,table_clean,table_insert,table_remove,refresh_table');
  ...
  $send(self, 'new', [(new Map([["method", "border"], ["type", "hash"], ["renderer", "html"]]))], function $$6(value, _user_proc){var self = $$6.$$s == null ? this : $$6.$$s, thickness = nil, $ret_or_1 = nil, type = nil, color = nil, color_found = nil;
    ...
    color = ($truthy(value['$[]']("color")) ? (((color_found = value['$[]']("color")), "" + ($rb_times(color_found.$red(), 255)) + "," + ($rb_times(color_found.$green(), 255)) + "," + ($rb_times(color_found.$blue(), 255)) + "," + (color_found.$alpha()) + " ")) : ("0,0,0,1"));
    return self.$html().$style("border", "" + (type) + " " + (thickness) + "px rgba(" + (color) + ")");}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "clean"], ["renderer", "html"], ["type", "hash"]]))], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s;

    
    if (params == null) params = nil;
    return self.$html().$table_clean(params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "insert"], ["renderer", "html"], ["type", "hash"]]))], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s;

    
    if (params == null) params = nil;
    return self.$html().$table_insert(params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "remove"], ["renderer", "html"], ["type", "hash"]]))], function $$9(params){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (params == null) params = nil;
    return self.$html().$table_remove(params);}, {$$s: self});
  return $send(self, 'new', [(new Map([["method", "sort"], ["renderer", "html"], ["type", "hash"]]))], function $$10(params){var self = $$10.$$s == null ? this : $$10.$$s;
...
Opal.modules["renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,instance_of?,style,html,transform,center,attach');
  
  $send(self, 'new', [(new Map([["method", "top"], ["type", "integer"], ["renderer", "html"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s;

    
    if (params == null) params = nil;
    if (!$truthy(params['$instance_of?']($$('Symbol')))) {
      params = "" + (params) + "px"
    };
    return self.$html().$style("top", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "top"], ["type", "integer"], ["renderer", "html"], ["specific", "text"]]))], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("top", "" + (params) + "px");}, {$$s: self});
  self.$new((new Map([["method", "top"], ["type", "integer"], ["renderer", "html"], ["specific", "shadow"]])));
  $send(self, 'new', [(new Map([["method", "bottom"], ["type", "integer"], ["renderer", "html"]]))], function $$3(params){var self = $$3.$$s == null ? this : $$3.$$s;
    ...
    return self.$html().$style("bottom", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "bottom"], ["type", "integer"], ["renderer", "html"], ["specific", "text"]]))], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s;

    
    if (params == null) params = nil;
    return self.$html().$style("bottom", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "right"], ["type", "integer"], ["renderer", "html"]]))], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    return self.$html().$style("right", params);}, {$$s: self});
  $send(self, 'new', [(new Map([["method", "left"], ["type", "integer"], ["renderer", "html"]]))], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s;
    ...
    return self.$html().$style("left", params);}, {$$s: self});
  self.$new((new Map([["method", "left"], ["type", "integer"], ["specific", "color"], ["renderer", "html"]])));
  self.$new((new Map([["method", "left"], ["type", "integer"], ["renderer", "html"], ["specific", "shadow"]])));
...
Opal.modules["renderers/html/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,delete,html,id,hypertext,hyperedit,read,browse,terminal,===,call,merge,match,==,host,file_for_opal,getElementById,[],global,to_s,createElement,[]=,addEventListener,Native,puts,file_handler,readAsText,click,appendChild,create_file_browser,select_text,getBoundingClientRect,to_f');
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "hyperedit"]]))], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s;

    
    if (params == null) params = nil;
    return self.$html().$hyperedit(params);}, {$$s: self});
  ...
  $send(self, 'new', [(new Map([["renderer", "html"], ["method", "selected"], ["specific", "text"]]))], function $$16(value){var bloc = $$16.$$p || nil, self = $$16.$$s == null ? this : $$16.$$s;
  ...
  return $send(self, 'new', [(new Map([["method", "compute"], ["type", "hash"], ["renderer", "html"]]))], function $$17(params){var $a, self = $$17.$$s == null ? this : $$17.$$s, element = nil, bounding_box = nil, top = nil, left = nil, width = nil, height = nil, value_found = nil, $ret_or_1 = nil;
    if (self.id == null) self.id = nil;
...
Opal.modules["atome/helpers/sanitizer"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server');
  
  default_render = $$('Essentials').$default_params()['$[]']("render_engines");
  $$('Atome').$new((new Map([["renderers", []], ["id", "eDen"], ["type", "element"], ["tag", (new Map([["system", true]]))]])));
  $$('Atome').$new((new Map([["renderers", []], ["id", "user_view"], ["type", "element"], ["tag", (new Map([["system", true]]))], ["attach", "eDen"]])));
  ...
  $$('Atome').$new((new Map([["renderers", default_render], ["id", "black_matter"], ["type", "shape"], ["attach", "user_view"], ["left", 0], ["right", 0], ["top", 0], ["bottom", 0], ["width", 0], ["height", 0], ["overflow", "hidden"], ["tag", (new Map([["system", true]]))]])));
  $$('Atome').$new((new Map([["renderers", default_render], ["id", "view"], ["type", "shape"], ["attach", "user_view"], ["apply", ["view_color"]], ["tag", (new Map([["system", true]]))], ["left", 0], ["right", 0], ["top", 0], ["bottom", 0], ["width", "auto"], ["height", "auto"], ["overflow", "auto"]])));
  $$('Atome').$new((new Map([["renderers", default_render], ["id", "intuition"], ["type", "shape"], ["attach", "user_view"], ["tag", (new Map([["system", true]]))], ["left", 0], ["top", 0], ["width", 0], ["height", 0], ["overflow", "visible"]])));
  machine_id = "dummy_machine";
  machine_password = (new Map([["read", (new Map([["atome", "star_wars"]]))], ["write", (new Map([["atome", "star_wars"]]))]]));
  $$('Atome').$new((new Map([["renderers", ["html"]], ["id", "copy"], ["collect", []], ["type", "group"], ["tag", (new Map([["system", true]]))]])));
  ...
  self.$human((new Map([["id", "anonymous"], ["login", true], ["password", user_password], ["data", (new Map([["birthday", "10/05/1996"]]))], ["selection", []], ["tag", (new Map([["system", true]]))], ["attach", "user_view"]])));
  ...
  $$('Atome').$new((new Map([["renderers", ["html"]], ["id", "selector"], ["collect", []], ["type", "group"], ["tag", (new Map([["system", true]]))]])));
  return $def(self, '$atome_infos', function $$atome_infos() {
    var self = this, server = nil, $ret_or_1 = nil;

    
    self.$puts("atome version: " + ($$$($$('Atome'), 'VERSION')));
    self.$puts("device identity: " + ($$('Universe').$app_identity()));
    ...
    return self.$puts("server: " + (server));
  });
};
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$require("atome/genesis/generators/hierarchy");
  self.$require("atome/genesis/generators/identity");
  self.$require("atome/genesis/generators/material");
  self.$require("atome/genesis/generators/property");
  self.$require("atome/genesis/generators/security");
  ...
  self.$require("atome/helpers/security");

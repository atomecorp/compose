...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.3.6")
...
Opal.modules["atome/genesis/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,atome_infos,server,init_websocket,message,particle_list,each,password');
  ...
  $def(self, '$init_database', function $$init_database() {
    ...
    $send($$('A'), 'message', [(new Map([["action", "init_db"], ["data", (new Map([["database", "eDen"]]))]]))], function $$5(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    particles = $$('Universe').$particle_list();
    $send($$('A'), 'message', [(new Map([["action", "crate_db_table"], ["data", (new Map([["table", "user"]]))]]))], function $$6(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "user"], ["column", "email"], ["type", "string"]]))]]))], function $$7(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "user"], ["column", "password"], ["type", "string"]]))]]))], function $$8(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "crate_db_table"], ["data", (new Map([["table", "history"]]))]]))], function $$9(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "history"], ["column", "aid"], ["type", "string"]]))]]))], function $$10(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "history"], ["column", "particle"], ["type", "string"]]))]]))], function $$11(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "history"], ["column", "value"], ["type", "string"]]))]]))], function $$12(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "history"], ["column", "date"], ["type", "datetime"]]))]]))], function $$13(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    $send($$('A'), 'message', [(new Map([["action", "crate_db_table"], ["data", (new Map([["table", "atome"]]))]]))], function $$14(_db_state){
      
      if (_db_state == null) _db_state = nil;
      return nil;});
    return $send(particles, 'each', [], function $$15(particle, infos){var type = nil;

      
      if (particle == null) particle = nil;
      if (infos == null) infos = nil;
      type = infos['$[]']("type");
      return $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", "atome"], ["column", particle], ["type", type]]))]]))], function $$16(_db_state){
  ...
  return $def(self, '$user_login', function $$user_login() {
    ...
    $send(self, 'message', [(new Map([["action", "authentication"], ["data", (new Map([["email", "jeezs@atome.one"]]))]]))], function $$17(email){var self = $$17.$$s == null ? this : $$17.$$s;

      
      if (email == null) email = nil;
      return self.$puts("email received : " + (email));}, {$$s: self});
    return $send(self, 'message', [(new Map([["action", "authorization"], ["data", (new Map([["password", password]]))]]))], function $$18(pass){var self = $$18.$$s == null ? this : $$18.$$s;
...
Opal.modules["molecules/init"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $truthy = Opal.truthy, $find_super = Opal.find_super, $send2 = Opal.send2, $def = Opal.def, $klass = Opal.klass, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],grab,clear,box,color,include,new');
  ...
  return self.$new((new Map([["application", "compose"], ["header", true], ["footer", true]])));
};
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  self.$require("atome/genesis/atome");
  ...
  return self.$require("molecules/init");
});

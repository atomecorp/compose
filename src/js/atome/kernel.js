...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.8.6")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attr_reader,attr_accessor,[]=,[],delete,to_sym,merge!,push,+,each,tag,<<,id,gsub,uuid,strftime,now,generate_uuid,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,connected,sync,%,setItem,length');
  return (function($base, $super, $parent_nesting) {
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('key?,add_atomes_specificities,[],build_atome,to_proc,particle_list,puts,instance_variable_set,build_particle,build_sanitizer,[]=,initialized,set_atomes_specificities,build_render,build_molecule,add_to_molecule_list,include,to_h,map,reject,include?,merge,delete,grab,to_sym,app_identity,counter,atomes,==,atomes_ids,instance_of?,box,circle,define_method,default_params,send,eval,new,object_id,*,global,is_a?,instance_exec,call,<<,-,length,===,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,instance_variable_get,update_style,parse');
  ...
  (function($base, $parent_nesting) {
    ...
    return $def(self, '$new', function $ObjectExtension_new$1(params) {
      var bloc = $ObjectExtension_new$1.$$p || nil, self = this, renderer_found = nil, render_method = nil, molecule = nil;
...
Opal.modules["atome/genesis/particles/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "value"]]))], function $$21(val){var self = $$21.$$s == null ? this : $$21.$$s, pro_f = nil;
    ...
    return val;}, {$$s: self});
  return self.$new((new Map([["particle", "behavior"]])));
};
...
Opal.modules["atome/genesis/particles/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "executor"], ["category", "utility"], ["type", "hash"]]))], function $$30(params){var self = $$30.$$s == null ? this : $$30.$$s;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "tick"], ["store", false]]))], function $$32(val){var $a, self = $$32.$$s == null ? this : $$32.$$s, $ret_or_1 = nil;
...
Opal.modules["molecules/intuition/utillities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $send(self, 'new', [(new Map([["molecule", "button"]]))], function $$16(params, bloc){var self = $$16.$$s == null ? this : $$16.$$s, $ret_or_1 = nil, states = nil, new_id = nil, back_col = nil, default_parent = nil, attach_to = nil, renderer_found = nil, button = nil;
    ...
    $send(button, 'touch', ["down"], function $$17(){
      ...
      button.$tick("button");
      return bloc.$call(button.$tick()['$[]']("button")['$%'](states));});

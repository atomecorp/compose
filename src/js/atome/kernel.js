...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.1.4")
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$init_database', function $$init_database() {
      var self = this;

      return self.$message((new Map([["action", "init_db"], ["value", (new Map([["atome", (new Map())], ["particles", (new Map())]]))]])))
    });
  })($nesting[0], null, $nesting);
};
...
Opal.modules["eVe/eVe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('puts');
  return self.$puts("so cool!!!")
};

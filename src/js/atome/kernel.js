...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.0.0")
      ...
      return $def(self, '$new_atome', function $$new_atome(element) {
        ...
        $send($$('Atome'), 'define_method', [element], function $$7(params){var user_proc = $$7.$$p || nil, self = $$7.$$s == null ? this : $$7.$$s, collected_atomes = nil;
          ...
          if ($truthy(params)) {
            ...
            return self.$group((new Map([["collect", collected_atomes]])));
          };}, {$$arity: -1, $$s: self});
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('key?,add_atomes_specificities,[],build_atome,to_proc,instance_variable_set,build_particle,build_sanitizer,set_atomes_specificities,[]=,build_render,define_method,call,to_h,map,reject,include?,merge,delete,grab,counter,==,instance_of?,to_sym,atomes,box,circle,default_params,send,eval,new,object_id,*,global,is_a?,instance_exec,<<,-,length,===,puts,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,particle_list,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,instance_variable_get,update_style');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$reorder_particles', function $$reorder_particles(hash_to_reorder) {
      ...
      ordered_part = $send(ordered_keys, 'map', [], function $$3(k){
        
        if (k == null) k = nil;
        return [k, hash_to_reorder['$[]'](k)];}).$to_h();
      other_part = $send(hash_to_reorder, 'reject', [], function $$4(k, _){
    ...
    $def(self, '$delete', function $Object_delete$5(atomes) {
      var self = this;
    ...
    $def(self, '$atome_method_for_object', function $$atome_method_for_object(element) {
      ...
      return $send($$('Object'), 'define_method', [element], function $$6(params){var user_proc = $$6.$$p || nil, self = $$6.$$s == null ? this : $$6.$$s, default_parent = nil, $ret_or_1 = nil;
    ...
    $def(self, '$tagged', function $$tagged(params) {
      ...
      if ($truthy(params['$instance_of?']($$('Hash')))) {
        $send(params, 'each', [], function $$7(tag_name, tag_value){
          
          if (tag_name == null) tag_name = nil;
          if (tag_value == null) tag_value = nil;
          return $send($$('Universe').$atomes(), 'each', [], function $$8(atomes_id_found, atomes_found){var $a;
        ...
        $send($$('Universe').$atomes(), 'each', [], function $$9(atomes_id_found, atomes_found){var $a;
    ...
    $def(self, '$shortcut', function $$shortcut($kwargs) {
      ...
      $send(element_ids, 'each', [], function $$10(element_id){var element = nil;
        ...
        if ($eqeq(element_id.$to_sym(), "all")) {
          ...
          $send(element, 'addEventListener', ["mouseenter"], function $$11(){
            return ($gvars.current_hovered_element = element_id)});
          return $send(element, 'addEventListener', ["mouseleave"], function $$12(){
            return ($gvars.current_hovered_element = nil)});
        };});
      return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["keydown"], function $$13(native_event){var self = $$13.$$s == null ? this : $$13.$$s, event = nil, key_pressed = nil, ctrl_pressed = nil, alt_pressed = nil, meta_pressed = nil, modifier_matched = nil, $ret_or_1 = nil, affect_condition = nil, exclude_condition = nil;
    ...
    $def(self, '$console', function $$console(debug) {try { 
      ...
      if ($truthy(debug)) {
        ...
        $send(console_top, 'touch', ["double"], function $$14(){
          
          console.$height(25);
          console.$bottom(0);
          return console.$top("auto");});
        console_top.$shadow((new Map([["id", "s1"], ["left", 0], ["top", 3], ["blur", 9], ["invert", false], ["red", 0], ["green", 0], ["blue", 0], ["alpha", 1]])));
        $send(console, 'drag', ["locked"], function $$15(event){var self = $$15.$$s == null ? this : $$15.$$s, dy = nil, y = nil, total_height = nil;
        ...
        $send(console_clear, 'touch', [true], function $$16(){
          return console_output.$data("")});
        return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["contextmenu"], function $$17(event){
        ...
        return $send($$('JS').$global()['$[]']("document"), 'addEventListener', ["contextmenu"], function $$18(native_event){var self = $$18.$$s == null ? this : $$18.$$s, event = nil;
    ...
    $def(self, '$importer_all', function $$importer_all() {try { 
      ...
      ;
      $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["dragover"], function $$19(native_event){var self = $$19.$$s == null ? this : $$19.$$s, event = nil;

        
        if (native_event == null) native_event = nil;
        event = self.$Native(native_event);
        return event.$preventDefault();}, {$$s: self});
      return $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["drop"], function $$20(native_event){var self = $$20.$$s == null ? this : $$20.$$s, event = nil, files = nil;
        ...
        if ($truthy($rb_gt(files['$[]']("length").$to_i(), 0))) {
          return $send(Opal.Range.$new(0,files['$[]']("length").$to_i(), true), 'each', [], function $$21(i){var self = $$21.$$s == null ? this : $$21.$$s, file = nil, reader = nil;
            ...
            $send(reader, 'addEventListener', ["load"], function $$22(){
              return proc.$call((new Map([["content", reader['$[]']("result").$to_s()], ["name", file['$[]']("name").$to_s()], ["type", file['$[]']("type").$to_s()], ["size", file['$[]']("size").$to_s()]])))});
            return $send(reader, 'addEventListener', ["error"], function $$23(){var self = $$23.$$s == null ? this : $$23.$$s;
    ...
    $def(self, '$exception_import', function $$exception_import(atome_id) {try { 
      ...
      if ($truthy($$('Universe').$user_atomes()['$include?'](atome_id.$to_sym()))) {
        ...
        $send(special_div, 'addEventListener', ["dragover"], function $$24(native_event){var self = $$24.$$s == null ? this : $$24.$$s, event = nil;
        ...
        $send(special_div, 'addEventListener', ["dragleave"], function $$25(native_event){var self = $$25.$$s == null ? this : $$25.$$s, event = nil;
          ...
          return event.$stopPropagation();}, {$$s: self});
        $send(special_div, 'addEventListener', ["drop"], function $$26(native_event){var self = $$26.$$s == null ? this : $$26.$$s, event = nil, files = nil;
          ...
          files = event['$[]']("dataTransfer")['$[]']("files");
          if ($truthy($rb_gt(files['$[]']("length").$to_i(), 0))) {
            return $send(Opal.Range.$new(0,files['$[]']("length").$to_i(), true), 'each', [], function $$27(i){var self = $$27.$$s == null ? this : $$27.$$s, file = nil, reader = nil;
              ...
              reader = $$('JS').$eval("let a= new FileReader(); return a");
              reader.$readAsText(file);
              $send(reader, 'addEventListener', ["load"], function $$28(){
                return proc.$call((new Map([["content", reader['$[]']("result").$to_s()], ["name", file['$[]']("name").$to_s()], ["type", file['$[]']("type").$to_s()], ["size", file['$[]']("size").$to_s()]])))});
              return $send(reader, 'addEventListener', ["error"], function $$29(){var self = $$29.$$s == null ? this : $$29.$$s;

                return self.$puts($rb_plus("Error: ", file['$[]']("name").$to_s()))}, {$$s: self});}, {$$s: self})
          } else {
            return nil
          };}, {$$s: self});
        return $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["drop"], function $$30(native_event){var self = $$30.$$s == null ? this : $$30.$$s, event = nil;
    ...
    $def(self, '$infos', function $$infos() {
      ...
      infos = (new Map());
      $send(particle_list, 'each', [], function $$31(particle_found){var $a, self = $$31.$$s == null ? this : $$31.$$s;
    ...
    $def(self, '$dig', function $$dig() {
      ...
      ids = [];
      dig_recursive = $send(self, 'lambda', [], function $$32(atome){var self = $$32.$$s == null ? this : $$32.$$s;

        
        if (atome == null) atome = nil;
        ids['$<<'](atome.$id());
        return $send(atome.$attached(), 'each', [], function $$33(attached_atome){var self = $$33.$$s == null ? this : $$33.$$s;
    ...
    $def(self, '$fit', function $$fit(params) {
      ...
      if ($eqeq(axis, "x")) {
        ...
        return $send(atomes_found, 'each', [], function $$34(atome_id){var self = $$34.$$s == null ? this : $$34.$$s, current_atome = nil, new_width = nil, new_height = nil;
        ...
        return $send(atomes_found, 'each', [], function $$35(atome_id){var self = $$35.$$s == null ? this : $$35.$$s, current_atome = nil;
    ...
    $def(self, '$found_area_used', function $$found_area_used(ids) {
      ...
      $send(ids, 'each', [], function $$36(id){var self = $$36.$$s == null ? this : $$36.$$s, atome = nil, x = nil, y = nil, width = nil, height = nil;
    ...
    $def(self, '$calculate_total_size', function $$calculate_total_size(objet_atome, axis) {
      ...
      $send(objet_atome.$attached(), 'each', [], function $$37(child_id){var self = $$37.$$s == null ? this : $$37.$$s, child = nil, child_size = nil, other_axis_size = nil;
    ...
    $def(self, '$resize_and_reposition', function $$resize_and_reposition(objet_atome, scale_factor, axis, max_other_axis_size) {
      ...
      return $send(objet_atome.$attached(), 'each', [], function $$38(child_id){var self = $$38.$$s == null ? this : $$38.$$s, child = nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$[]', function $CssProxy_$$$39(key) {
      var $a, self = this;
    ...
    $def(self, '$[]=', function $CssProxy_$$$eq$40(key, value) {
      var self = this;
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('include,[],identity_generator,new,[]=,reorder_particles,collapse,object,html,particle_main,to_proc,instance_variable_set,particle_pre,particle_callback,store_proc,render,particle_post,particle_after,reject,instance_variables,==,join,map,inspect,instance_variable_get,class');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    return $def(self, '$inspect', function $$inspect() {
      ...
      filtered_vars = $send(self.$instance_variables(), 'reject', [], function $$1(var$){var $ret_or_1 = nil;
      ...
      content = $send(filtered_vars, 'map', [], function $$2(var$){var self = $$2.$$s == null ? this : $$2.$$s;
...
Opal.modules["atome/genesis/generators/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$new((new Map([["atome", "color"], ["type", "template"]])));
};
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,[]=,identity_generator,merge,reject,has_key?,include?,==,reorder_particles,grab,length,atomes,new,to_proc,atome_common,preset_common');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
...
Opal.modules["atome/genesis/generators/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,[]=,current_user,password,atome_list,particle_list,connect,html,to_proc,instance_of?,send_message,controller_sender,[],int8');
...
Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "layout"]]))], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, mode_found = nil, $ret_or_1 = nil, elements_style = nil, atomes_to_organise = nil, container_name = nil, container = nil, container_class = nil, id_found = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "center"], ["type", "hash"]]))], function $$9(params){
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "compute"]]))], function $$29(params){var $ret_or_1 = nil;
    ...
    return params;});
  $send(self, 'new', [(new Map([["particle", "get"]]))], function $$30(params){var self = $$30.$$s == null ? this : $$30.$$s, cell = nil, row_nb = nil, column_nb = nil;
  ...
  self.$new((new Map([["particle", "css"]])));
  return $send(self, 'new', [(new Map([["read", "css"]]))], function $$31(){var self = $$31.$$s == null ? this : $$31.$$s;
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.id = $proto.callback = $proto.current_server = nil;
    ...
    $def(self, '$each_with_index', function $$each_with_index() {
      ...
      ;
      index = 0;
      return $send(self.$collect(), 'each', [], function $$9(val){var self = $$9.$$s == null ? this : $$9.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$10(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$11(value) {
      var self = this;
    ...
    return $def(self, '$init_websocket', function $$init_websocket() {
      var self = this;
...
Opal.modules["renderers/html/html"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$connect', function $$connect(params) {try { 
      var bloc = $$connect.$$p || nil, type = nil, server = nil, user = nil, pass = nil, atomes = nil, particles = nil;
      ...
      return $$('JS').$eval("atomeJS.connect('" + (type) + "','" + (server) + "','" + (user) + "','" + (pass) + "'," + (atomes.$to_json()) + "," + (particles.$to_json()) + ")");} catch($e) {
        if ($e === Opal.t_eval_return) return $e.$v;
        throw $e;
      }
    });
...
Opal.modules["renderers/html/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,shape,html,svg,image,video,www,raw,text,add_class,[]=,[],int8,language,to_s,js,svg_data,each,send,update_svg_data,path,raw_data,table,atomized,alien');
...
Opal.modules["renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,is_a?,[],[]=,js,transform,html,style,center,attach');
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,server');
  ...
  $$('Atome').$new((new Map([["renderers", default_render], ["id", "intuition"], ["type", "shape"], ["attach", "user_view"], ["tag", (new Map([["system", true]]))], ["left", 0], ["top", 0], ["bottom", 0], ["width", 0], ["height", "auto"], ["overflow", "visible"]])));
  ...
  return $$('A').$server((new Map([["address", "localhost:9292"], ["type", "ws"]])));
};

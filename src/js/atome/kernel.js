...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.2.7")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $return_ivar = Opal.return_ivar, $def = Opal.def, $truthy = Opal.truthy, $send = Opal.send, $slice = Opal.slice, $hash_rehash = Opal.hash_rehash, $rb_plus = Opal.rb_plus, $assign_ivar_val = Opal.assign_ivar_val, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $assign_ivar = Opal.assign_ivar, $neqeq = Opal.neqeq, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      self.$attr_reader("atomes", "atomes_ids", "renderer_list", "atome_list", "particle_list", "classes", "counter", "atomes_specificities");
      
      $def(self, '$messages', $return_ivar("messages"));
      
      $def(self, '$eVe', function $$eVe(val) {
        var self = this;
        if (self.eve == null) self.eve = nil;
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('key?,include?,atome_list,[],puts,add_atomes_specificities,build_atome,to_proc,particle_list,instance_variable_set,build_particle,build_sanitizer,set_atomes_specificities,[]=,build_render,include,to_h,map,reject,merge,delete,grab,to_sym,counter,atomes,==,atomes_ids,instance_of?,box,circle,define_method,default_params,send,eval,new,object_id,*,global,is_a?,instance_exec,call,<<,-,length,===,each,tag,uniq,+,Array,querySelector,addEventListener,Native,downcase,to_s,!,nil?,touch,height,bottom,top,shadow,drag,to_px,to_f,text,data,preventDefault,>,to_i,readAsText,user_atomes,getElementById,stopPropagation,importer_all,exception_import,dup,lambda,id,attached,dig,found_area_used,/,left,width,compute,min,max,resize_object,instance_variable_get,update_style');
  ...
  (function($base, $parent_nesting) {
    ...
    return $def(self, '$new', function $ObjectExtension_new$1(params) {
      var bloc = $ObjectExtension_new$1.$$p || nil, self = this, renderer_found = nil, render_method = nil;
      ...
      if ($truthy(params['$key?']("atome"))) {
        if ($truthy($$('Universe').$atome_list()['$include?'](params['$[]']("atome")))) {
          self.$puts("atome " + (params['$[]']("atome")) + " already exist you can't create it")
        } else {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$identity_generator', function $$identity_generator(type_needed) {
      ...
      return ((("" + (type_needed)) + "_") + ($$('Universe').$counter())).$to_sym();
    }, -1);
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $truthy = Opal.truthy, $send = Opal.send, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('include,identity_generator,add_to_atomes,[],id_to_aid,new,[]=,reorder_particles,collapse,object,html,particle_main,to_proc,instance_variable_set,particle_pre,particle_callback,store_proc,render,particle_post,particle_after,reject,instance_variables,==,join,map,inspect,instance_variable_get,class');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$initialize', function $$initialize(new_atome) {
      ...
      self.int8 = (new Map());
      self.css = (new Map());
      self.aid = self.$identity_generator("a");
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('[],default_params,[]=,identity_generator,merge,reject,has_key?,include?,==,reorder_particles,new,to_proc,atome_common,preset_common');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
...
Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "overflow"], ["category", "event"], ["type", "boolean"]]))], function $$11(params, bloc){var self = $$11.$$s == null ? this : $$11.$$s, $ret_or_1 = nil;
    ...
    return params;}, {$$s: self});
  return $send(self, 'new', [(new Map([["particle", "animate"]]))], function $$12(params){var self = $$12.$$s == null ? this : $$12.$$s;
...
Opal.modules["atome/genesis/generators/hierarchy"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attach,grab,delete,attached,==,attached=,include?,push,detach_child,render,to_proc,new,attachment_common,instance_of?,each,<<,id,instance_variable_get,instance_variable_set,apply,detach_atome');
...
Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $neqeq = Opal.neqeq, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,to_sym,[],atomes,puts,!=,update_atome_id,add_to_atomes,instance_of?,each,<<,grab,collect=,==,selection,current_user,delete,collect');
  ...
  $send(self, 'new', [(new Map([["sanitizer", "id"]]))], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s;
    ...
    if ($truthy($$('Universe').$atomes()['$[]'](params))) {
      
      self.$puts("the id : " + (params) + " is already used");
      params = self.id;
    } else if ($neqeq(self.id.$to_sym(), params)) {
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "duplicate"], ["category", "utility"], ["type", "string"], ["store", false]]))], function $$18(params){var self = $$18.$$s == null ? this : $$18.$$s, copy_number = nil, new_atome_id = nil, new_atome = nil, attached_atomes = nil, attached_found = nil, particles_found = nil, keys_to_delete = nil, $ret_or_1 = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "copy"], ["category", "utility"], ["type", "string"]]))], function $$24(items_id){var self = $$24.$$s == null ? this : $$24.$$s;
  ...
  $send(self, 'new', [(new Map([["particle", "paste"], ["category", "utility"], ["type", "string"]]))], function $$25(params){var self = $$25.$$s == null ? this : $$25.$$s, all_copies = nil, copies_found = nil, new_atomes = nil, applies_found = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "compute"], ["category", "utility"], ["type", "string"]]))], function $$29(params){var $ret_or_1 = nil;
    ...
    return params;});
  $send(self, 'new', [(new Map([["particle", "get"], ["category", "utility"], ["type", "string"]]))], function $$30(params){var self = $$30.$$s == null ? this : $$30.$$s, cell = nil, row_nb = nil, column_nb = nil;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $to_ary = Opal.to_ary, $rb_plus = Opal.rb_plus, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,current_machine=,puts,app_identity,aui,host,engine,users,current_user,current_machine,current_server,example,text,touch,delete,help,atome_infos,server,init_websocket,message,particle_list,categories,each,length,each_with_index,+,==,user_login,password');
  ...
  $def(self, '$init_database', function $$init_database() {
    var self = this, particles = nil, categories = nil, particles_length = nil;

    
    $send($$('A'), 'message', [(new Map([["action", "init_db"], ["data", (new Map([["database", "eDen"]]))]]))], function $$5(db_state){var self = $$5.$$s == null ? this : $$5.$$s;

      
      if (db_state == null) db_state = nil;
      return self.$puts(db_state);}, {$$s: self});
    particles = $$('Universe').$particle_list();
    categories = $$('Universe').$categories();
    $send(categories, 'each', [], function $$6(category){var self = $$6.$$s == null ? this : $$6.$$s;

      
      if (category == null) category = nil;
      return $send($$('A'), 'message', [(new Map([["action", "crate_db_table"], ["data", (new Map([["table", category]]))]]))], function $$7(db_state){var self = $$7.$$s == null ? this : $$7.$$s;

        
        if (db_state == null) db_state = nil;
        return self.$puts(db_state);}, {$$s: self});}, {$$s: self});
    particles_length = particles.$length();
    return $send(particles, 'each_with_index', [], function $$8($mlhs_tmp1, index){var $a, $b, self = $$8.$$s == null ? this : $$8.$$s, particle = nil, infos = nil, type = nil, table = nil;

      
      if ($mlhs_tmp1 == null) $mlhs_tmp1 = nil;
      if (index == null) index = nil;
      $b = $mlhs_tmp1, $a = $to_ary($b), (particle = ($a[0] == null ? nil : $a[0])), (infos = ($a[1] == null ? nil : $a[1])), $b;
      type = infos['$[]']("type");
      table = infos['$[]']("category");
      self.i = 1;
      return $send($$('A'), 'message', [(new Map([["action", "create_db_column"], ["data", (new Map([["table", table], ["column", particle], ["type", type]]))]]))], function $$9(db_state){var self = $$9.$$s == null ? this : $$9.$$s;
        if (self.i == null) self.i = nil;

        
        if (db_state == null) db_state = nil;
        self.i = $rb_plus(self.i, 1);
        if ($eqeq(self.i, particles_length)) {
          self.$user_login()
        };
        return self.$puts(db_state);}, {$$s: self});}, {$$s: self, $$has_top_level_mlhs_arg: true});
  });
  return $def(self, '$user_login', function $$user_login() {
    ...
    $send(self, 'message', [(new Map([["action", "authentication"], ["data", (new Map([["email", "jeezs@atome.one"]]))]]))], function $$10(email){var self = $$10.$$s == null ? this : $$10.$$s;

      
      if (email == null) email = nil;
      return self.$puts("email received : " + (email));}, {$$s: self});
    return $send(self, 'message', [(new Map([["action", "authorization"], ["data", (new Map([["password", password]]))]]))], function $$11(pass){var self = $$11.$$s == null ? this : $$11.$$s;

      
      if (pass == null) pass = nil;
      return self.$puts("password recieved : " + (pass));}, {$$s: self});
  });
};

Opal.modules["eVe/eVe"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.8.2 */

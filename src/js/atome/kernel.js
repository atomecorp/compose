...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.7.5")
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('attr_reader,attr_accessor,[]=,[],delete,instance_variable_get,to_sym,merge!,push,+,each,tag,<<,id,gsub,uuid,strftime,now,generate_uuid,===,=~,last_match,downcase,==,to_s,global,include?,platform_type,current_machine_decision,!=,internet,html,grab,encode,password,connected,sync,%,setItem,length');
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      self.$attr_accessor("connected", "allow_sync", "allow_localstorage", "database_ready");
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    (function(self, $parent_nesting) {
      ...
      return $def(self, '$monitoring', function $$monitoring(atomes_to_monitor, particles_to_monitor) {
        ...
        ;
        return $send(atomes_to_monitor, 'each', [], function $$2(atome_to_monitor){var self = $$2.$$s == null ? this : $$2.$$s;

          
          if (atome_to_monitor == null) atome_to_monitor = nil;
          return $send(particles_to_monitor, 'each', [], function $$3(monitored_particle){var self = $$3.$$s == null ? this : $$3.$$s, original_method = nil;

            
            if (monitored_particle == null) monitored_particle = nil;
            original_method = atome_to_monitor.$method(monitored_particle);
            return $send(atome_to_monitor, 'define_singleton_method', [monitored_particle], function $$4($a){var proc = $$4.$$p || nil, $post_args, args, self = $$4.$$s == null ? this : $$4.$$s, value_before = nil;
    ...
    $def(self, '$collapse', function $$collapse(new_atome) {
      ...
      $send(new_atome, 'each', [], function $$5(element, value){var self = $$5.$$s == null ? this : $$5.$$s, initialized_proc = nil;
      ...
      return $send(initialized_procs, 'each', [], function $$6(value){var self = $$6.$$s == null ? this : $$6.$$s;

        
        if (value == null) value = nil;
        return $send(value, 'each', [], function $$7(val, proc){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    $def(self, '$particle_callback', function $$particle_callback(element) {
      ...
      return $send($$('Atome'), 'define_method', ["" + (element) + "_callback"], function $$8(return_params){var self = $$8.$$s == null ? this : $$8.$$s, proc_found = nil;
    ...
    $def(self, '$particles', function $$particles(particles_found) {
      ...
      if ($truthy(particles_found)) {
        return $send(particles_found, 'each', [], function $$9(particle_found, value_found){var $a, self = $$9.$$s == null ? this : $$9.$$s;
    ...
    $def(self, '$atome', function $$atome() {
      ...
      return $send(self.$instance_variables(), 'each_with_object', [(new Map())], function $$10(var$, hash){var $a, self = $$10.$$s == null ? this : $$10.$$s;
    ...
    $def(self, '$particles_to_hash', function $$particles_to_hash() {
      ...
      hash = (new Map());
      $send(self.$instance_variables(), 'each', [], function $$11(var$){var $a, self = $$11.$$s == null ? this : $$11.$$s;
    ...
    $def(self, '$refresh', function $$refresh() {
      ...
      $send(particles_found, 'each', [], function $$12(particle_found, value_found){var self = $$12.$$s == null ? this : $$12.$$s;

        
        if (particle_found == null) particle_found = nil;
        if (value_found == null) value_found = nil;
        return self.$send(particle_found, value_found);}, {$$s: self});
      return $send(self.$color(), 'each', [], function $$13(col){var self = $$13.$$s == null ? this : $$13.$$s;
    ...
    $def(self, '$each_with_index', function $$each_with_index() {
      ...
      ;
      index = 0;
      return $send(self.$collect(), 'each', [], function $$15(val){var self = $$15.$$s == null ? this : $$15.$$s;
    ...
    $def(self, '$<<', function $Atome_$lt$lt$16(item) {
      var self = this;

      return self.$collect()['$<<'](item)
    });
    
    $def(self, '$include?', function $Atome_include$ques$17(value) {
      var self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$18(particle, value){var self = $$18.$$s == null ? this : $$18.$$s;
    ...
    $def(self, '$get_localstorage_content', function $$get_localstorage_content() {
      ...
      $send(storage_array, 'each_with_index', [], function $$19(_i, index){var $a, key = nil, value = nil;
    ...
    return $def(self, '$alternate', function $$alternate($a) {
      ...
      if ($truthy(current_state['$instance_of?']($$('Hash')))) {
        $send(current_state, 'each', [], function $$20(state, value){var self = $$20.$$s == null ? this : $$20.$$s;
...
Opal.modules["molecules/intuition/sliders"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $rb_minus = Opal.rb_minus, $rb_times = Opal.rb_times, $rb_divide = Opal.rb_divide, $rb_plus = Opal.rb_plus, $def = Opal.def, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],box,grab,shadow,circle,left,top,drag,-,*,/,+,width,call');
  return (function($base) {
    var self = $module($base, 'Molecule');

    
    return $def(self, '$slider', function $$slider(params) {
      var bloc = $$slider.$$p || nil, self = this, slider_width = nil, $ret_or_1 = nil, cursor_width = nil, cursor_height = nil, left_pos = nil, top_pos = nil, attach_to = nil, cursor_left = nil, cursor_top = nil, slider = nil, cursor = nil;

      $$slider.$$p = null;
      
      ;
      slider_width = ($truthy(($ret_or_1 = params['$[]']("width"))) ? ($ret_or_1) : (333));
      cursor_width = 33;
      cursor_height = 33;
      left_pos = ($truthy(($ret_or_1 = params['$[]']("left"))) ? ($ret_or_1) : (0));
      top_pos = ($truthy(($ret_or_1 = params['$[]']("top"))) ? ($ret_or_1) : (0));
      attach_to = ($truthy(($ret_or_1 = params['$[]']("attach"))) ? ($ret_or_1) : ("view"));
      cursor_left = 0;
      cursor_top = 0;
      slider = self.$grab(attach_to).$box((new Map([["top", top_pos], ["left", left_pos], ["width", slider_width], ["height", 25], ["smooth", 9], ["color", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))]])));
      slider.$shadow((new Map([["id", "s2"], ["left", 3], ["top", 3], ["blur", 9], ["invert", true], ["red", 0], ["green", 0], ["blue", 0], ["alpha", 0.7]])));
      cursor = slider.$circle((new Map([["width", cursor_width], ["height", cursor_height], ["left", 2], ["top", 1], ["color", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))]])));
      ...
      $send(cursor, 'drag', [(new Map([["restrict", (new Map([["max", (new Map([["left", $rb_minus(slider_width, cursor_width)], ["top", 0]]))]]))]]))], function $$1(_event){var value = nil;

        
        if (_event == null) _event = nil;
        value = $rb_times($rb_divide($rb_plus(cursor.$left(), cursor.$width()), slider_width), 100);
        return bloc.$call(value);});
      return slider;
    })
  })($nesting[0])
};
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$require("molecules/intuition/sliders");
});

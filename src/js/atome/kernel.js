...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.6.7.2")
...
Opal.modules["atome/utilities/utilities"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $gvars = Opal.gvars, $thrower = Opal.thrower, $slice = Opal.slice, $to_a = Opal.to_a, $defs = Opal.defs, $hash_rehash = Opal.hash_rehash, $not = Opal.not, $range = Opal.range, $rb_plus = Opal.rb_plus, self = Opal.top, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $const_set = Opal.const_set, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, $a, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, default_render = nil, machine_id = nil, machine_password = nil, user_password = nil;

  Opal.add_stubs('[],default_params,new,human,identity_generator,current_machine=,puts,aui,app_identity,host,engine,users,current_user,current_machine,example,text,touch,delete,help,atome_infos,current_server,start_with?,server,init_websocket,sync,database_ready=,==,particle_list,each,send_localstorage_content,password,allow_history=');

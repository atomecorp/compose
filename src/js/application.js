Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, form = nil, email_box = nil, email_text = nil, password_box = nil, password_text = nil, connection = nil, creation = nil;

  Opal.add_stubs('box,color,text,touch,component,empty?,strip,data,nil?,puts,+,encode,message');

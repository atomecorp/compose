Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,touch,==,target,delete,text,component,message,puts,inspect,[],key?,setItem,global,empty?,strip,data,nil?,+,encode,connect,data=,!,valid_email_format?,email_exists,getItem,identity_generator,match?,db_access,sanitized_email,first,where');
  return $def(self, '$authent_form', function $$authent_form() {
    var self = this, dark_grey = nil, dark_grey_transparent = nil, grey = nil, light_grey = nil, eastern_blue = nil, view = nil, form = nil, cancel = nil, email_box = nil, email_bordure_bas = nil, email_text = nil, password_box = nil, password_bordure_bas = nil, password_text = nil, connection = nil, creation = nil, wrong_email_format = nil;
    ...
    wrong_email_format = form.$text((new Map([["data", ""], ["left", 20], ["top", 115], ["color", "red"]])));
    self.$puts("blabla : " + (wrong_email_format.$data()));

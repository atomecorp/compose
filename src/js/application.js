Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,touch,==,target,delete,text,puts,data,component,message,inspect,[],key?,setItem,global,data=,empty?,strip,nil?,+,encode,connect,!,valid_email_format?,is_a?,getItem,identity_generator,match?,db_access,sanitized_email,first,where');
  return $def(self, '$authent_form', function $$authent_form() {
    ...
    $send(creation, 'touch', [true], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s, mail = nil;
      ...
      if ((($truthy(email_text.$data()['$nil?']()) || ($truthy(email_text.$data().$strip()['$empty?']()))) && (($truthy(password_text.$data()['$nil?']()) || ($truthy(password_text.$data().$strip()['$empty?']())))))) {
        ...
        if ($not(self['$valid_email_format?'](mail))) {
          ...
          return $send($$('A'), 'message', [(new Map([["action", "email_exist"], ["data", (new Map([["email", mail]]))]]))], function $$9(response){var self = $$9.$$s == null ? this : $$9.$$s, pass = nil, anon_id = nil, e = nil;
    ...
    $def(self, '$valid_email_format?', function $valid_email_format$ques$10(email) {
    ...
    return $def(self, '$email_exist?', function $email_exist$ques$11(mail) {

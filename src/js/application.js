Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,text,color,touch,component,empty?,strip,data,nil?,puts,+,encode,message,language=,authent_form');
  ...
  $def(self, '$authent_form', function $$authent_form() {
    ...
    view = self.$box((new Map([["id", "poipoi"], ["left", 0], ["right", 0], ["top", 0], ["bottom", 0], ["height", 704], ["width", 1536], ["color", dark_grey]])));
    ...
    connection = form.$box((new Map([["width", 100], ["height", 50], ["left", 50], ["top", 250], ["color", "white"], ["smooth", 5], ["border", (new Map([["thickness", 2], ["color", self.$color(eastern_blue)], ["pattern", "solid"]]))], ["text", (new Map([["int8", (new Map([["francais", "Se connecter"], ["english", "Login"]]))], ["color", "black"]]))], ["id", "connection_btn"]])));
    ...
    creation = form.$box((new Map([["width", 110], ["height", 50], ["left", 340], ["top", 250], ["color", grey], ["smooth", 5], ["border", (new Map([["thickness", 2], ["color", self.$color(eastern_blue)], ["pattern", "solid"]]))], ["text", (new Map([["int8", (new Map([["francais", "Crer un compte"], ["english", "Create account"]]))], ["left", 10], ["color", "white"]]))], ["id", "creation_btn"]])));
    return $send(creation, 'touch', [true], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s, mail = nil, pass = nil;
      ...
      if ((($truthy(email_text.$data()['$nil?']()) || ($truthy(email_text.$data().$strip()['$empty?']()))) && (($truthy(password_text.$data()['$nil?']()) || ($truthy(password_text.$data().$strip()['$empty?']())))))) {
        ...
        pass = $$('Black_matter').$encode(password_text.$data());
        self.$puts($rb_plus("pass : ", pass));
        $$('A').$message((new Map([["action", "insert"], ["data", (new Map([["table", "identity"], ["particle", "email"], ["data", mail]]))]])));
        return $$('A').$message((new Map([["action", "insert"], ["data", (new Map([["table", "security"], ["particle", "password"], ["data", pass]]))]])));
      }}, {$$s: self});
  });

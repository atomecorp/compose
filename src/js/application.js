...
Opal.modules["templates/templat_interface"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $rb_plus = Opal.rb_plus, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('require,initialize_user,create_ui_elements,create_anonymous_box,create_second_box,create_navigation_button,create_logout_button,box,current_user,center,text,touch,color,creator,circle,+,==,is_logged,puts,message,top,left,width,height,box1,new,reset_to_anonymous');

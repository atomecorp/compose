      ...
      if ((($truthy(email_text.$data()['$nil?']()) || ($truthy(email_text.$data().$strip()['$empty?']()))) && (($truthy(password_text.$data()['$nil?']()) || ($truthy(password_text.$data().$strip()['$empty?']())))))) {
        ...
        $send($$('A'), 'message', [(new Map([["action", "authentication"], ["data", (new Map([["table", "user"], ["particles", (new Map([["email", mail]]))]]))]]))], function $$6(response){var self = $$6.$$s == null ? this : $$6.$$s;
          ...
          if ($truthy(response['$key?']("mail_authorized"))) {
            ...
            view.$delete(true);
            return $$('JS').$global()['$[]']("localStorage").$setItem("user_id", response['$[]']("user_id"));
          } else {
            return nil
          };}, {$$s: self});
        return $send($$('A'), 'message', [(new Map([["action", "authorization"], ["data", (new Map([["table", "user"], ["particles", (new Map([["password", pass]]))]]))]]))], function $$7(response){var self = $$7.$$s == null ? this : $$7.$$s, authorized = nil, $ret_or_1 = nil;
...
Opal.modules["templates/templat"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $not = Opal.not, $rb_plus = Opal.rb_plus, $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, current_user = nil, anonymous_id = nil, user_id = nil, box1 = nil, navigation_button = nil, logout_button = nil;

  Opal.add_stubs('current_user,puts,getItem,[],global,!,setItem,box,center,text,+,creator,touch,color,circle,authent_form');
  ...
  self.$puts("user anonymous_id : " + (anonymous_id));
  if ($not(anonymous_id)) {
  ...
  self.$puts("user stocked : " + (user_id));
  if ($not(user_id)) {
  ...
  return $send(logout_button, 'touch', [true], function $$3(){
    ...
    return $$('JS').$global()['$[]']("localStorage").$setItem("user_id", anonymous_id);});
};

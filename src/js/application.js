...
Opal.modules["templates/templat"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('getItem,[],global,puts,!,current_user,setItem,box,center,text,+,creator,touch,color,circle,authent_form,removeItem');
  ...
  return $send(logout_button, 'touch', [true], function $$3(){
    ...
    return $$('JS').$global()['$[]']("localStorage").$removeItem("user_id");});
};

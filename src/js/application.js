Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $def(self, '$authent_form', function $$authent_form() {
    ...
    $send(connection, 'touch', [true], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, mail = nil, pass = nil, mail_message = nil, mail_response = nil, password_message = nil, password_response = nil;
      ...
      if ((($truthy(email_text.$data()['$nil?']()) || ($truthy(email_text.$data().$strip()['$empty?']()))) && (($truthy(password_text.$data()['$nil?']()) || ($truthy(password_text.$data().$strip()['$empty?']())))))) {
        ...
        $send($$('A'), 'message', [(new Map([["action", "authentication"], ["data", (new Map([["table", "user"], ["particles", (new Map([["email", mail]]))]]))]]))], function $$6(response){var self = $$6.$$s == null ? this : $$6.$$s;
          ...
          if ($truthy(response['$key?']("mail_authorized"))) {
            ...
            return self.$puts("mail_response : " + (mail_response));
          } else {
            return nil
          };}, {$$s: self});
        $send($$('A'), 'message', [(new Map([["action", "authorization"], ["data", (new Map([["table", "user"], ["particles", (new Map([["password", pass]]))]]))]]))], function $$7(response){var self = $$7.$$s == null ? this : $$7.$$s, authorized = nil, $ret_or_1 = nil;
          ...
          if ($truthy(response['$key?']("password_authorized"))) {
            ...
            return self.$puts("password_response : " + (password_response));
          } else {
            return nil
          };}, {$$s: self});
        if (($eqeq(mail_response, "true") && ($eqeq(password_response, "true")))) {

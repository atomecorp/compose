Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,color,text,connection,puts,alert,touch,message,data');
  ...
  email_text = email_box.$text((new Map([["data", "Tapez votre email"], ["left", 25], ["edit", true], ["id", "email_text_id"]])));
  ...
  $send($$('A'), 'connection', ["localhost:9292"], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s;

    
    if (params == null) params = nil;
    self.$puts("Connected!!!!!!!!!!");
    return self.$alert(" the connection is : " + (params));}, {$$s: self});
  return $send(validation, 'touch', [true], function $$2(){
    return $$('A').$message((new Map([["mail", email_text.$data()], ["pass", password_text.$data()]])))});
};

Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  var $send = Opal.send, self = Opal.top, nil = Opal.nil, b = nil, c = nil;

  Opal.add_stubs('require,box,touch,connection,grab,puts,message');

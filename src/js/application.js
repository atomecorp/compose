Opal.modules["authentication/login_form"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,text,color,touch,component,empty?,strip,data,nil?,puts,+,encode,message,authent_form');
  ...
  $def(self, '$authent_form', function $$authent_form() {
    ...
    connection = form.$box((new Map([["width", 100], ["height", 50], ["left", 50], ["top", 250], ["color", "white"], ["smooth", 5], ["border", (new Map([["thickness", 2], ["color", self.$color(eastern_blue)], ["pattern", "solid"]]))], ["text", (new Map([["data", "Se connecter"], ["left", 10], ["color", "black"]]))], ["id", "connection_btn"]])));
    ...
    creation = form.$box((new Map([["width", 110], ["height", 50], ["left", 340], ["top", 250], ["color", grey], ["smooth", 5], ["border", (new Map([["thickness", 2], ["color", self.$color(eastern_blue)], ["pattern", "solid"]]))], ["text", (new Map([["data", "Crer un compte"], ["left", 10], ["color", "white"]]))], ["id", "creation_btn"]])));

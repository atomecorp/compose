...
def create_file_browser
  ...
  # Dfinir les proprits CSS de l'lment div
  ...
  div_element[:style][:top] = "0px"           # Position par rapport au haut de l'cran
  div_element[:style][:left] = "0px"          # Position par rapport  la gauche de l'cran

  # Dfinir un ID pour l'lment div
  ...
  div_element.addEventListener("mousedown") do |event|
    # Dclenchez manuellement un clic sur l'input
    input_element.click
  end
